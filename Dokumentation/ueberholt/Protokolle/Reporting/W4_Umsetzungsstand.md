...
| [`Grundlagen_KWKG_Energiesteuer_Stromsteuer.md`](../../../aktuell/Grundlagen_KWKG_Energiesteuer_Stromsteuer.md) | Rechtsstand mit Quellen — Faktenbasis aller Seed-Werte |
...
- **Die tragende Annahme war falsch, und die Recherche hat sie widerlegt.** Konzept
  ...
  [`Grundlagen_KWKG_Energiesteuer_Stromsteuer.md`](../../../aktuell/Grundlagen_KWKG_Energiesteuer_Stromsteuer.md),
  Abschnitt 3.5.
