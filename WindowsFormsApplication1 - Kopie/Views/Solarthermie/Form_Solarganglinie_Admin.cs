...
namespace WindowsFormsApplication1
{
    partial class Form_Solarganglinie_Admin : Form
    {
        ...
        public void SetControls()
        {
            ...
            {
                SolarganglinieCtrl model = new SolarganglinieCtrl(); 
        ...
        {
            SolarganglinieCtrl ctrl_ganglinie = new SolarganglinieCtrl();
        ...
        {
            SolarganglinieCtrl ctrl_ganglinie = new SolarganglinieCtrl();
            SolarganglinieDatenCtrl ctrl = new SolarganglinieDatenCtrl();
            ...
            ctrl_ganglinie.m_szBeschreibung = tool.textList[0];
            if (!ctrl_ganglinie.Insert()) return;

            // Daten in DB
            ctrl.list_GanglinieDaten.Clear();
            for (int i = 1; i < tool.textList.Count; i++)
            {
                SolarganglinieDatenModel model = new SolarganglinieDatenModel();
