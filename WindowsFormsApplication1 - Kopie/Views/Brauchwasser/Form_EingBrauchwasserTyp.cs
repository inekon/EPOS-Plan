...
namespace WindowsFormsApplication1
{
    public partial class Form_EingBrauchwasserTyp : Form
    {
        ...
        {
            RecordSet rs = new RecordSet();
            rs.Open("select * from Tab_Brauchwassertyp where Typname='" + listBox_Typname.Text + "'");
        ...
        {
            DBCommand.CommandText = "UPDATE Tab_Brauchwassertyp SET Beschreibung='" + szBeschreibung + "' WHERE Typname='" + szTyp + "'";
            try
            {
        ...
        {
            DBCommand.CommandText = "UPDATE Tab_Brauchwassertyp SET " + feld + "=" + value.ToString(CultureInfo.CreateSpecificCulture("en-US")) + " WHERE Typname='" + typ + "'";
            try
            {
                DBCommand.ExecuteNonQuery();
            }
        ...
        private void btn_Loeschen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DBCommand.CommandText = "DELETE Typname FROM Tab_Brauchwassertyp WHERE Typname='" + listBox_Typname.Text + "'";
                DBCommand.ExecuteNonQuery();
            }
        ...
        private void btn_Neu_Click(object sender, EventArgs e)
        {
            ...
            OdbcCommand DBCommand = Program.DBConnection.CreateCommand();
            DBCommand.CommandText = "INSERT INTO Tab_Brauchwassertyp ( Typname ) SELECT '" + frm.m_szName + "' AS Ausdr1";
            DBCommand.ExecuteNonQuery();
