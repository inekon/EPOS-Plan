...
namespace EPOS.Kern.Tests
{
    ...
    /// <c>{{kapitel.&lt;name&gt;}}</c>, erzeugt wie die Beispielvorlage (Werkzeug, Modus <c>beispiel</c>
    /// ohne <c>--sammelanker</c>; BV-E2). Die Beispielvorlage <c>Berichtsvorlage_Beispiel.docx</c> ist
