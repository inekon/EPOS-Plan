...
namespace EPOS.Kern.Tests
{
    ...
    /// 1.176.906,60 €/a; Messung auf der nach Schritt 109 migrierten Kopie, alle
    /// dreizehn Basisprojekte 9.195 von 9.195 Werten gleich, nach jedem der neun
    /// Punkte). Die Gründe: Schritt 107 legt die Kennzeichen Ersatz/Restwert leer an
    /// (leer = wie bisher), Schritt 108 füllt die Preisbasis aus der Umrechnungsregel,
    /// Schritt 109 ändert nur Stammtexte; keine Mischlage § 53/53a neben § 54, keine
