...
| [`aktuell/ADR-004_gbXML_LINQ_to_XML.md`](aktuell/ADR-004_gbXML_LINQ_to_XML.md) | ADR-004: gbXML-Leseweg mit LINQ to XML und handgeschriebenem Modell statt XmlSerializer, Version 6.01, Export zweistufig (Befund R); vorgeschlagen | 2026-09-15 |
| [`aktuell/ADR-005_Zonenkopplung_Mehrzonenmodell.md`](aktuell/ADR-005_Zonenkopplung_Mehrzonenmodell.md) | ADR-005: Zonenkopplung im Mehrzonenmodell über die Nachbarraum-Randbedingung mit Gauß-Seidel je Stunde (Mehrzonenkonzept M1); vorgeschlagen | 2026-09-15 |
