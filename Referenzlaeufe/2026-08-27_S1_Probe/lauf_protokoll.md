...
**Zielordner:** `C:\Waermeplan\WP_Plan\Referenzlaeufe\2026-08-27_S1_Probe`
...
Schema-Migration der Arbeitskopie ...
  ...
  Zeitpunkt: 27.08.2026 18:53:53
  Schemastand vorher: 49   (Zielstand 50)
  ...
  Senkenliste (Schritt 50): 68 Anlage(n) mit Rang-1-Senke uebernommen, davon 14 zusaetzlich mit Rang-2-Senke; Regel R-Prozess hat 8 Prozesswaerme-Zeile(n) ergaenzt.
  Schritt 50  Senkenliste: Z_AnlageSenke anlegen, die Senken-Slots als Raenge uebernehmen (inkl. Regel R-Prozess) und Z_AnlagePufferVerbund um ID_Senke erweitern (Paket S1, L4/L5/F17): OK
          - Tabelle Z_AnlageSenke: angelegt
          - Index idx_AnlageSenke: angelegt
          - Beziehung FK_AnlageSenke_Anlage (mit Loeschweitergabe): angelegt
          - Beziehung FK_AnlageSenke_Puffer (restriktiv): angelegt
          - Spalte Z_AnlagePufferVerbund.ID_Senke: angelegt
          - Regel R-Prozess: 8 Prozesswaerme-Zeile(n) angelegt, 1 nachfolgende(r) Rang um eins hochgeschoben.
  ...
  Schemastand nachher: 50   (Zielstand 50)
...
--- Projekt 1007 (Laurentiuskirche) ---
      | [18:53:54] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:53:54] Simulation startet fuer Projekt 1007 ...
      ...
      | [18:53:55] Simulation beendet, Ergebnis-Kopf-ID 207.
      | [18:53:55] Projekt 1007: 29 CSV-Dateien, 90 Skalare.
Projekt 1007: OK, 29 CSV-Dateien, 00:01
--- Projekt 1008 (Heinestr 15) ---
      | [18:53:55] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:53:55] Simulation startet fuer Projekt 1008 ...
      ...
      | [18:53:56] Simulation beendet, Ergebnis-Kopf-ID 208.
      | [18:53:56] Projekt 1008: 21 CSV-Dateien, 87 Skalare.
Projekt 1008: OK, 21 CSV-Dateien, 00:01
--- Projekt 1011 (test1) ---
      | [18:53:56] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:53:56] Simulation startet fuer Projekt 1011 ...
      ...
      | Simulation Hinweis: Wärmepumpe 'CS3400i AWS 10 E + CS3400i AWS 4 OR-S': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [18:53:57] Simulation beendet, Ergebnis-Kopf-ID 209.
      | [18:53:58] Projekt 1011: 29 CSV-Dateien, 112 Skalare.
Projekt 1011: OK, 29 CSV-Dateien, 00:01
--- Projekt 1017 (WP_PV-Speicher) ---
      | [18:53:58] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:53:58] Simulation startet fuer Projekt 1017 ...
      ...
      | [18:53:59] Simulation beendet, Ergebnis-Kopf-ID 210.
      | [18:53:59] Projekt 1017: 21 CSV-Dateien, 103 Skalare.
Projekt 1017: OK, 21 CSV-Dateien, 00:00
--- Projekt 1018 (BHKW Test München) ---
      | [18:53:59] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:53:59] Simulation startet fuer Projekt 1018 ...
      ...
      | [18:54:00] Simulation beendet, Ergebnis-Kopf-ID 211.
      | [18:54:00] Projekt 1018: 22 CSV-Dateien, 122 Skalare.
Projekt 1018: OK, 22 CSV-Dateien, 00:00
--- Projekt 1021 (TestSpeichernUnter) ---
      | [18:54:00] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:54:00] Simulation startet fuer Projekt 1021 ...
      ...
      | [18:54:00] Simulation beendet, Ergebnis-Kopf-ID 212.
      | [18:54:01] Projekt 1021: 21 CSV-Dateien, 80 Skalare.
Projekt 1021: OK, 21 CSV-Dateien, 00:00
--- Projekt 1023 (Wöhler - Test1) ---
      | [18:54:01] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:54:01] Simulation startet fuer Projekt 1023 ...
      ...
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 691 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: Wärmepumpe 'CS7800iLW 12': Die Quelltemperatur überschreitet in 166 Stunden die obere Stützstelle der Kennlinie (25,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | [18:54:01] Simulation beendet, Ergebnis-Kopf-ID 213.
      | [18:54:01] Projekt 1023: 25 CSV-Dateien, 118 Skalare.
Projekt 1023: OK, 25 CSV-Dateien, 00:00
--- Projekt 1024 (Wöhler - Test2) ---
      | [18:54:02] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:54:02] Simulation startet fuer Projekt 1024 ...
      | Simulation Hinweis: Das Projekt enthält ein BHKW - dieser Lauf rechnet deshalb IMMER über die Speicherstufe mit herausgelöster Ladephase (Konzept 6.3), unabhängig von der Projekteinstellung Kaskade_Zweikanalig. Der einkanalige BHKW-Altpfad ist entfallen (Paket BHKW-Regulär).
      ...
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | [18:54:02] Simulation beendet, Ergebnis-Kopf-ID 214.
      | [18:54:03] Projekt 1024: 26 CSV-Dateien, 135 Skalare.
Projekt 1024: OK, 26 CSV-Dateien, 00:00
--- Projekt 1030 (Referenz BHKW-Kaskade (Regressionstest)) ---
      | [18:54:03] DB-Pfad der App verifiziert: C:\Waermeplan\WP_Plan\Referenzlaeufe\Arbeitskopie\Kenndaten.accdb
      | [18:54:03] Simulation startet fuer Projekt 1030 ...
      | Simulation Hinweis: Das Projekt enthält ein BHKW - dieser Lauf rechnet deshalb IMMER über die Speicherstufe mit herausgelöster Ladephase (Konzept 6.3), unabhängig von der Projekteinstellung Kaskade_Zweikanalig. Der einkanalige BHKW-Altpfad ist entfallen (Paket BHKW-Regulär).
      | [18:54:03] Simulation beendet, Ergebnis-Kopf-ID 215.
      | [18:54:04] Projekt 1030: 22 CSV-Dateien, 130 Skalare.
