            ...
            get
            {
                return new[]
                {
                    new Paar(SchemaKatalog.SPALTE_EA_KWKG_SATZ_EIGEN,
                             KwkgProjektaltspalten.SPALTE_BONUS,             false, true),
                    new Paar(SchemaKatalog.SPALTE_EA_KWKG_SATZ_EINSP,
                             KwkgProjektaltspalten.SPALTE_BONUS_EINSPEISUNG, false, true),
                    new Paar(SchemaKatalog.SPALTE_EA_KWKG_KONTINGENT,
                             KwkgProjektaltspalten.SPALTE_KONTINGENT,        false, true),
                    ...
                    new Paar(SchemaKatalog.SPALTE_EA_KWKG_EIGENFALL,
                             KwkgProjektaltspalten.SPALTE_TATBESTAND,        true,  true),
