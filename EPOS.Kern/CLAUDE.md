...
Der plattformfreie Kern von EPOS-Plan: **311 `.cs`-Dateien** (168 aus iU4, dazu
...
dotnet test  ..\WP-Plan.Kern.slnf -c Release            # 3 087 Tests (Stand iU9-W14b)
```
