...
`9ab55946` · `SchemaStand.Zielversion` = **114**, Schemaschritte 90–114 vergeben (105 = K‑1, #440; 108–110 =
Kühlung KU1; 111–113 = die Schritte E, F, G, #446; 114 = Kühlung KU2), **115 zugesagt (Zapfprofil T2), 116–118 an E9a
vergeben (Schritte B, C, D)** · Gegenstand: das konsolidierte Konzept
...
> **Nachtrag 23./24.09.2026 (#432 bis #460).** Gebaut sind inzwischen auch **E4** (#432), **E5** (#434),
...
> E8c‑Q1 und E8c‑Q2 offen); der Schnitt **A13** ist mit #435 ausgeführt. **Laufende Etappe: E9** (Teil a, E9a). Die
...
> zugesagt ist 115 (Zapfprofil-Stufe Z3, T2) — die Schritte B, C und D der Etappe E9 sind 116, 117 und 118 (E9a).
...
5. **Das Datenmodell ist gesünder als das Konzept sagt:** alle 20 Wirtschaftlichkeitstabellen sind
   ...
   ist 105, gebaut #440; E, F und G sind 111, 112 und 113, gebaut #446; B, C und D sind als 116, 117 und 118 an E9a
   vergeben) und ein
...
| **E9 V‑E Szenarioabdeckung** — **Teil a (E9a) läuft** | Schritte **B–D** (Zeitraum und Mengenfaktor, Trägerpreise, Erlössätze), ±-Knopf an drei neuen Orten, Kern liest die Paare, Hinweistext entfällt; **ohne Degradation** (A5) | L | **ja**, je Pflege (NULL = wie Erwartet) | A/B je Projekt, Referenzlauf byte-gleich, `SzenarioParameterTests` je Größe | B = 116, C = 117, D = 118 (vergeben 24.09.2026; 114 ist die Kühlung KU2, 115 der Zapfprofil-Stufe Z3 zugesagt) | Wirtschaftlichkeit `szenarien`; wesentlich | Opus | A5 entschieden; E5, E7 — in zwei Wellen: **E9a** Schema, Kern und Tests samt A/B (voraussichtlich #461), **E9b** die Dialoge, der Hinweistext entfällt (voraussichtlich #462) |
...
Teil a — umgesetzt #454, E8 Teil b — umgesetzt #455, E8c — umgesetzt #460** (Einzelheiten in der Tafel oben, in den
...
liest die Paare) läuft, E9b (die Dialoge) folgt; offen sind die acht Fragen aus E7c3 und die zwei aus E8c, die sechs
aus E8b sind entschieden. **E9 bis E12** bleiben offen, E11 entfällt.
...
Commit `24074b3a`). `SchemaStand.Zielversion` steht auf **114**. **Vergabe vom 24.09.2026:** 115 ist der
Zapfprofil-Stufe Z3 zugesagt (T2, in Umsetzung), die Schritte B, C und D der Etappe E9 sind **116, 117 und 118**
(E9a); der nächste freie Schritt danach ist 119. Die Angabe vom 23.09.2026 („114 Zapfprofil-Stufe Z3, 115
...
| **B** | 98 | Szenariorahmen: `Szen_Best/Worst_Zeitraum`, `Szen_Best/Worst_Menge` (nicht `_Dauer`) | `Tab_ProjektWirtschaftlichkeit` | **ja** | nein | E9a — Nummer **116** (vergeben 24.09.2026) |
| **C** | 99 | Trägerpreise best/worst: `custom_price_work/base/power_best/_worst` | `energy_project_settings` | nein | nein | E9a — Nummer **117** (vergeben 24.09.2026) |
| **D** | 100 | Erlössätze best/worst: `Einspeiseverguetung(_KWK)_Best/_Worst`; `DvEntgelt_Best/_Worst`, `PpaPreis_Best/_Worst` | `Tab_ProjektWirtschaftlichkeit`, `Tab_ProjektPhotovoltaik` | **ja** (PPV) | nein | E9a — Nummer **118** (vergeben 24.09.2026) |
