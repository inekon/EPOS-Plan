...
| Nr. | Frage | Empfehlung |
|---|---|---|
| **BF1** | § 9 Abs. 1 Nr. 3 als Ausweis statt Erlös (BW3) — nach der Probe B1 umstellen, oder Bestandsverhalten dauerhaft belassen? | **umstellen, wenn B1 die Doppelzählung bestätigt**; bis dahin Vorgabe = Bestand |
