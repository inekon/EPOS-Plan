...
`954d4dcc` · `SchemaStand.Zielversion` = **104**, Schemaschritte 90–104 vergeben, 105 an K‑1 (E7c),
**nächster freier Schritt 106** · Gegenstand: das konsolidierte Konzept
...
> **Nachtrag 23.09.2026 (#432 bis #439).** Gebaut sind inzwischen auch **E4** (#432), **E5** (#434),
> **E6** (#436), **E7 Teil a** (#437: Nr. 29, Nr. 30 ohne die Kern-Regel, Nr. 32) und **E7 Teil b** (#439:
> Q11 — kein Zeitzonentarif, Leistungspreis-Staffel am Stromträger, Tarifdialog im Rollenmodell; E7b‑Q1 bis
> E7b‑Q4 am 23.09.2026 entschieden); der Schnitt **A13** ist mit #435 ausgeführt. **Nächste Etappe: E7c**
> (die übrigen rechenwirksamen Lücken; E7‑Q1, E7‑Q2 und E7‑Q3 sind am 23.09.2026 entschieden). Die
> Schemaschritte sind am 23.09.2026 neu geordnet (§ 6): 101 Gebäudesimulation, 102 Nr. 30, 103
> Zapfprofilgenerator, 104 Q11, 105 K‑1.
...
5. **Das Datenmodell ist gesünder als das Konzept sagt:** alle 20 Wirtschaftlichkeitstabellen sind
   ...
   bekommt 105, die übrigen ab **106**) und ein DML-Schritt für den Einheitenbruch, der
...
umgesetzt #439** (Einzelheiten in der Tafel oben, in den Statuszeilen und ihren Protokollen); der
**A13-Schnitt** ist mit #435 ausgeführt. **Nächste Etappe:** **E7c** (die übrigen rechenwirksamen Lücken,
nach den Entscheiden vom 23.09.2026 zu E7‑Q1, E7‑Q2 und E7‑Q3; K‑1 mit Schemaschritt 105). **E7c bis E12**
bleiben offen, E11 entfällt.
...
Zeitzonentarif wird abgelöst, die Leistungspreis-Staffel zieht an den Stromträger (Q11, #439).
`SchemaStand.Zielversion` steht auf **104**; den **nächsten freien Schritt, 105,** bekommt K‑1 (Schritt
**A**, E7c), danach ist **106** frei.
...
106), und der Umsetzende misst sie an `SchemaStand.Zielversion` neu — nicht an diesem Papier. Alle
...
| **A** | 97 | K‑1: `KWKG_Abwaermeabfuhr` (0/1, CHECK), `KWKG_Stromkennzahl` (nullbar) | `Tab_Energieanlagen` | nein | nein | E7c — entschieden 23.09.2026, Nummer **105** (104 an E7b) |
