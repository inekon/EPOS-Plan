...
Aufräumcommit `ca257fb8`, Merge `da24a5d9` von `origin` (`b0eb1783`), Papiere im Folgecommit. **Kein Schemaschritt, die Testdatenbank ist unberührt.** Alle Gates im
...
| Papiere | N18, dieses Protokoll, Statuszeile #508, Indexzeilen in `Dokumentation/LIESMICH.md` | Folgecommit |
...
- **Sichtabnahme unter Windows:** Reiter Kennzahlen mit stochastischer Jahresreihe und **einer** Zone
  — die Streuung steht als Zahl; mit zwei stochastischen Zonen steht ein Strich und der Grund in der
  Warnliste.
