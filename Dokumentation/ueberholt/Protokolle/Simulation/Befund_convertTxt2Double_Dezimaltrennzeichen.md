...
`Program.convertTxt2Double` ([`Program.cs:311`](../../../../WindowsFormsApplication1/Program.cs)) ruft
...
2. Nicht-numerischer Feldinhalt wirft `FormatException`. In `UebernehmeEintrag` gefangen
   ...
   [`Form_WP_einlesen.cs:117`](../../../../WindowsFormsApplication1/Views/Wärmepumpe/Form_WP_einlesen.cs),
   [`Form_Heizkessel_einlesen.cs:64`](../../../../WindowsFormsApplication1/Views/Heizkessel/Form_Heizkessel_einlesen.cs),
   [`Form_PufferSp_einlesen.cs:106`](../../../../WindowsFormsApplication1/Views/Pufferspeicher/Form_PufferSp_einlesen.cs).
...
`listBox_PV_SelectedIndexChanged` ([`Form_AdminPV.cs:150–170`](../../../../WindowsFormsApplication1/Views/Photovoltaik/Form_AdminPV.cs))
...
([`Program.cs:209/275`](../../../../WindowsFormsApplication1/Program.cs)) — Komma **und** Punkt als Dezimaltrennzeichen,
