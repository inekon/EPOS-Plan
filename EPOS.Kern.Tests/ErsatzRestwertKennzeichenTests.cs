...
{
    /// <summary>
    /// ETAPPE E7c — <b>Schritt E (Schemaschritt 111): Ersatz und Restwert je Position
    ...
    public class ErsatzRestwertKennzeichenTests : IDisposable
    {
        ...
        [Fact]
        public void Der_Zielstand_ist_111_und_der_Schritt_hat_vier_nullbare_Spalten()
        {
            Assert.True(SchemaStand.Zielversion >= 111,
                        "Zielstand " + SchemaStand.Zielversion + " liegt unter 111.");

            SchemaSpalte[] spalten = SchemaKatalog.Schritt111_ErsatzRestwertKennzeichen;
