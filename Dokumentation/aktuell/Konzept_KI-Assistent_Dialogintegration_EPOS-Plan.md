...
- **Stand der Abdeckung.** Angemeldet sind alle Masken mit Einstellwerten; die Ausnahmeliste führt keinen
  `Offen`-Eintrag. Draußen mit Vermerk in der Eingabebilanz bleiben allein die Zahlenfolgen (Monatswerte eines
  Bedarfstyps, Kurven des Gebäudetyps, Stundenwerte eines Kostenprofils, Profil- und Leistungspreisreihen) — sie
  brauchen die Rahmenerweiterung für Zahlenfolgen. **Überlagerungen mit eigenem Arbeitsstand** (Kennlinieneditor,
