...
| [`ueberholt/Protokolle/EPOS.Kern_Import/`](ueberholt/Protokolle/EPOS.Kern_Import/) | 2 | `PvKatalog_Koeffizienten_Protokoll.md` — Befund und Reparatur der PV-Modulkoeffizienten (Schemaschritt 69); `Katalograhmen_Ueberlagerung_KL5_Protokoll.md` — Befund KL-5: Eingabeblock, Diagramm und Fußleiste überlagerten die Katalogliste (gemessene Ursache und Behebung im Katalograhmen) |
