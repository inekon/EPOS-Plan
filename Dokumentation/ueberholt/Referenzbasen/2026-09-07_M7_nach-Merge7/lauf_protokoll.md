...
**Zeitpunkt:** 07.09.2026 23:13:08

**Quelle (produktiv, nur gelesen):** `P:\pa0\Quelle\Kenndaten.sqlite`

**Arbeitskopie (beschrieben):** `K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite`

**Zielordner:** `K:\m7\ref_m5`

**Gesamtdauer:** 00:00:20  |  **Timeout je Projekt:** 300 s
...
Arbeitskopie angelegt: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite (64 MB)
DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite

Schema-Migration der Arbeitskopie ...
  K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
  Zeitpunkt: 07.09.2026 23:12:48
  Schemastand vorher: 61   (Zielstand 69)
  Schritt 62 - Tab_Solar_STAMM: Waisen vorher 0, nachher 0.
  Schritt 62 - Tab_Klimadaten_STAMM: Waisen vorher 0, nachher 0.
  Schritt 62  Verwaiste Klimadaten abraeumen (Stunden- und Tageswerte ohne Kopfsatz): OK
          - Tab_Solar_STAMM: verwaiste Zeilen loeschen: ausgefuehrt
          - Tab_Klimadaten_STAMM: verwaiste Zeilen loeschen: ausgefuehrt
          - 62: Altbereinigung der Klimadaten-Waisen (Entscheid E-6). Es gab nichts zu tun - kein Datenblock ohne Kopfsatz. KEIN Rechenergebnis aendert sich: Eine Waise hat keinen Kopfsatz und ist ueber keine Abfrage des Programms erreichbar.
  Schritt 63  PV-Anlagenparameter (PV_WrWirkungsgrad, PV_Systemverluste) an Tab_Energieanlagen anlegen (Paket A, Stufe E1.3): OK
          - Tab_Energieanlagen.PV_WrWirkungsgrad: angelegt
          - Tab_Energieanlagen.PV_Systemverluste: angelegt
          - 63: 2 Spalte(n) (PV_WrWirkungsgrad, PV_Systemverluste) an Tab_Energieanlagen sichergestellt. KEIN DML: beide Spalten bleiben NULL, und NULL heisst 0,95 (Wechselrichter-Wirkungsgrad) bzw. 0 % (Systemverluste) - genau der bisher fest verdrahtete Rechenweg. KEIN Rechenergebnis aendert sich.
  Schritt 64  PV-Modellwahl (PV_Modell, Wechselrichterangaben, Technologie, Degradation) anlegen (Paket B, Stufe E2): OK
          ...
          - 64: 8 Spalte(n) sichergestellt - PV_Modell, PV_WrNennleistungKw, PV_WrEta10, PV_WrEta50, PV_WrEta100 an Tab_Energieanlagen, Technologie an Tab_PV und Tab_PV_STAMM, Degradation an Tab_ProjektPhotovoltaik. KEIN DML: alle acht Spalten bleiben NULL. NULL heisst bei PV_Modell "Modell EINFACH", also der Rechenweg aus Paket A, und bei der Degradation 0 %/a. KEIN Rechenergebnis aendert sich.
  Schritt 65  Wechselrichterkatalog (Tab_Wechselrichter_STAMM) und seine Projektkopie (Tab_Wechselrichter) anlegen (Stufe S1): OK
          - Tab_Wechselrichter_STAMM: angelegt
          - Tab_Wechselrichter: angelegt
          - 65: 2 von 2 Tabelle(n) angelegt (Tab_Wechselrichter_STAMM, Tab_Wechselrichter). KEIN DML: beide Tabellen sind nach dem Schritt LEER, kein Projekt fuehrt eine Kopie, und kein Rechenweg liest sie. KEIN Rechenergebnis aendert sich.
  Schritt 66  Strangzuordnung (Z_AnlageStrang) und den sichtbaren Wechselrichterweg (Tab_Energieanlagen.PV_Wechselrichterweg) anlegen (Stufe S2): OK
          - Z_AnlageStrang: angelegt
          - Tab_Energieanlagen.PV_Wechselrichterweg: angelegt
          - 66: 1 von 1 Tabelle(n) angelegt (Z_AnlageStrang), 1 Spalte sichergestellt (Tab_Energieanlagen.PV_Wechselrichterweg). KEIN DML: die Tabelle ist nach dem Schritt LEER, die Spalte bleibt NULL, und NULL heisst "vereinfacht" - der Rechenweg von heute, Zeichen fuer Zeichen. KEIN Rechenergebnis aendert sich.
  Schritt 67 - Tab_Einstellungen: Saetze ohne gepflegte Leistungsgrenze vorher 6, nachher 0.
  Schritt 67  Die projektweite BHKW-Leistungsuntergrenze sichtbar machen: Tab_Einstellungen.Leistungsgrenze NULL -> 30 (W6-E-7): OK
          - Tab_Einstellungen.Leistungsgrenze: NULL auf 30 anheben: ausgefuehrt
          - 67: Die projektweite BHKW-Leistungsuntergrenze wird sichtbar (Entscheid W6-E-7). 6 Satz/Saetze ohne gepflegten Wert auf 30 % gehoben. KEIN Rechenergebnis aendert sich: Genau diese Saetze rechneten bisher ueber den stillen Fallback in SimulationBHKW mit denselben 30 %. Eine gepflegte 0 bleibt 0 - sie ist eine Angabe des Anwenders ("keine Untergrenze"), keine Luecke.
  Schritt 68 - Tab_Stromspeicher_STAMM: Saetze mit Praefix und ohne Hersteller vorher 0, nachher 0 (Katalog gesamt 5).
  Schritt 68  Den Hersteller des Stromspeicherkatalogs anlegen: Tab_Stromspeicher_STAMM.Firma und Tab_Stromspeicher.Firma, Nachtrag aus dem Bezeichnerpraefix (W14a-E-10-Q7): OK
          - Tab_Stromspeicher_STAMM.Firma: angelegt
          - Tab_Stromspeicher.Firma: angelegt
          - Tab_Stromspeicher_STAMM.Firma: aus dem Bezeichnerpraefix nachtragen: ausgefuehrt
          - 68: Der Stromspeicherkatalog bekommt seine Herstellerspalte (Entscheid W14a-E-10-Q7) - 2 Spalte(n) sichergestellt (Tab_Stromspeicher_STAMM und Tab_Stromspeicher). Nachzutragen gab es nichts - kein Satz traegt ein Bezeichnerpraefix. KEIN Rechenergebnis aendert sich: Kein Rechenweg liest den Hersteller - der Speicher wird ueber Bezeichner und ID gefunden.
  Schritt 69 - Wertequelle: 4 eingebettete Auslieferungsmodule (die CEC-Liste liegt nicht am Herstellerdatenpfad: C:\Users\DirkEngelmann\AppData\Local\WP-Plan\PV\CEC Modules.csv - es gelten die eingebetteten Werte).
  Schritt 69 - PV-Modul "Jinkosolar JKM 260P-60" (Tab_PV_STAMM ID 8): alpha_SC, beta_OC, gamma_PMP, T_NOCT verdorben (Kopie von I_Kurzschluss), kein Treffer in der CEC-Liste - auf leer gesetzt. Pflege ueber den Modulkatalog.
  Schritt 69 - Tab_PV_STAMM: Saetze mit verdorbenem Koeffizienten vorher 4, nachher 0 (Katalog gesamt 6).
  Schritt 69 - PV-Modul "Jinkosolar JKM 260P-60" (Tab_PV ID 1011008): alpha_SC, beta_OC, gamma_PMP, T_NOCT verdorben (Kopie von I_Kurzschluss), kein Treffer in der CEC-Liste - auf leer gesetzt. Pflege ueber den Modulkatalog.
  Schritt 69 - PV-Modul "Jinkosolar JKM 260P-60" (Tab_PV ID 1015244): alpha_SC, beta_OC, gamma_PMP, T_NOCT verdorben (Kopie von I_Kurzschluss), kein Treffer in der CEC-Liste - auf leer gesetzt. Pflege ueber den Modulkatalog.
  Schritt 69 - PV-Modul "Jinkosolar JKM 260P-60" (Tab_PV ID 1015245): alpha_SC, beta_OC, gamma_PMP, T_NOCT verdorben (Kopie von I_Kurzschluss), kein Treffer in der CEC-Liste - auf leer gesetzt. Pflege ueber den Modulkatalog.
  Schritt 69 - PV-Modul "Jinkosolar JKM 260P-60" (Tab_PV ID 1015246): alpha_SC, beta_OC, gamma_PMP, T_NOCT verdorben (Kopie von I_Kurzschluss), kein Treffer in der CEC-Liste - auf leer gesetzt. Pflege ueber den Modulkatalog.
  Schritt 69 - Tab_PV: Saetze mit verdorbenem Koeffizienten vorher 6, nachher 0 (Katalog gesamt 6).
  Schritt 69  Die verdorbenen PV-Modulkoeffizienten reparieren: alpha_SC, beta_OC, gamma_PMP und T_NOCT in Tab_PV_STAMM und Tab_PV aus der CEC-Liste (W6-B-5): OK
          - Tab_PV_STAMM "Ablytek 6MN6A270": Koeffizienten aus der CEC-Liste: ausgefuehrt
          - Tab_PV_STAMM "Ablytek 6MN6A275": Koeffizienten aus der CEC-Liste: ausgefuehrt
          - Tab_PV_STAMM "Ablytek 6MN6A290": Koeffizienten aus der CEC-Liste: ausgefuehrt
          - Tab_PV_STAMM.alpha_SC: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV_STAMM.beta_OC: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV_STAMM.gamma_PMP: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV_STAMM.T_NOCT: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV "Ablytek 6MN6A270": Koeffizienten aus der CEC-Liste: ausgefuehrt
          - Tab_PV "Ablytek 6MN6A275": Koeffizienten aus der CEC-Liste: ausgefuehrt
          - Tab_PV.alpha_SC: aus dem Stammsatz uebernehmen: ausgefuehrt
          - Tab_PV.beta_OC: aus dem Stammsatz uebernehmen: ausgefuehrt
          - Tab_PV.gamma_PMP: aus dem Stammsatz uebernehmen: ausgefuehrt
          - Tab_PV.T_NOCT: aus dem Stammsatz uebernehmen: ausgefuehrt
          - Tab_PV.alpha_SC: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV.beta_OC: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV.gamma_PMP: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - Tab_PV.T_NOCT: verdorbene Werte ohne Treffer auf leer: ausgefuehrt
          - 69: Die verdorbenen PV-Modulkoeffizienten sind repariert (Befund W6-B-5, Entscheide Q1 bis Q3). 10 Satz/Saetze angefasst, in Stammtabelle und Projektkopie. Was keinen Treffer in der CEC-Liste hat, steht jetzt auf leer - der Modulkatalog sagt "nicht gepflegt", statt den Kurzschlussstrom als Temperaturkoeffizient auszugeben. ANDERS ALS DIE SCHRITTE 62 BIS 68 ist dieser NICHT ergebnisneutral: T_NOCT geht in beide PV-Modelle, und wo der Katalogwert bisher ausserhalb des Fensters 20 bis 60 Grad C lag, rechnete die Simulation mit dem Rueckfall 45 Grad C. Genau das war der Zweck (Entscheid Q3).
  Schemastand nachher: 69   (Zielstand 69)
Migration: ERFOLG (Zielstand 69).
...
--- Projekt 1007 (Laurentiuskirche) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:50] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:50] Simulation startet fuer Projekt 1007 ...
      ...
      | [23:12:51] Simulation beendet, Ergebnis-Kopf-ID 208.
      | [23:12:51] Projekt 1007: 29 CSV-Dateien, 99 Skalare.
Projekt 1007: OK, 29 CSV-Dateien, 00:01
--- Projekt 1008 (Heinestr 15) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:51] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:52] Simulation startet fuer Projekt 1008 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [23:12:52] Simulation beendet, Ergebnis-Kopf-ID 209.
      | [23:12:52] Projekt 1008: 21 CSV-Dateien, 101 Skalare.
Projekt 1008: OK, 21 CSV-Dateien, 00:01
--- Projekt 1011 (test1) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:53] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:53] Simulation startet fuer Projekt 1011 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Wärmepumpe 'CS3400i AWS 10 E + CS3400i AWS 4 OR-S': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 0.000 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      ...
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [23:12:54] Simulation beendet, Ergebnis-Kopf-ID 210.
      | [23:12:54] Projekt 1011: 29 CSV-Dateien, 121 Skalare.
Projekt 1011: OK, 29 CSV-Dateien, 00:01
--- Projekt 1017 (WP_PV-Speicher) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:54] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:55] Simulation startet fuer Projekt 1017 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: BHKW: Emissionsfaktoren: Dem Modul „BHKW EW K 10 S [K] Heizol" ist kein Energieträger zugeordnet - es gilt ersatzweise Brennstoffkatalog „Stadtgas“ (kein Energieträger zugeordnet). Mit zugeordnetem Energieträger rechnet der Lauf mit dem gepflegten Wert aus dem Emissionskatalog.
      | Simulation Hinweis: Heizkessel: Emissionsfaktoren: Der Kessel „eloBLOCK VE 28" hat keinen Energieträger zugeordnet - es gilt ersatzweise Brennstoffkatalog „Elektrische Energie“ (kein Energieträger zugeordnet). Mit zugeordnetem Energieträger rechnet der Lauf mit dem gepflegten Wert aus dem Emissionskatalog.
      | Simulation Hinweis: Zum Stichtag 01.01.2026 gab es noch keine Preisversion - es gilt die aelteste vorhandene.
      | [23:12:55] Simulation beendet, Ergebnis-Kopf-ID 211.
      | [23:12:55] Projekt 1017: 21 CSV-Dateien, 124 Skalare.
Projekt 1017: OK, 21 CSV-Dateien, 00:01
--- Projekt 1018 (BHKW Test München) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:55] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:56] Simulation startet fuer Projekt 1018 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Heizkessel: Emissionsfaktoren: Der Kessel „Vitocrossal 200 CM2 raumluftabh�ngig" hat keinen Energieträger zugeordnet - es gilt ersatzweise Brennstoffkatalog „Erdgas E“ (kein Energieträger zugeordnet). Mit zugeordnetem Energieträger rechnet der Lauf mit dem gepflegten Wert aus dem Emissionskatalog.
      | [23:12:56] Simulation beendet, Ergebnis-Kopf-ID 212.
      | [23:12:56] Projekt 1018: 22 CSV-Dateien, 151 Skalare.
Projekt 1018: OK, 22 CSV-Dateien, 00:01
--- Projekt 1021 (TestSpeichernUnter) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:57] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:57] Simulation startet fuer Projekt 1021 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [23:12:57] Simulation beendet, Ergebnis-Kopf-ID 213.
      | [23:12:57] Projekt 1021: 21 CSV-Dateien, 94 Skalare.
Projekt 1021: OK, 21 CSV-Dateien, 00:01
--- Projekt 1023 (Wöhler - Test1) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:58] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:58] Simulation startet fuer Projekt 1023 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Heizkessel: Emissionsfaktoren: Der Kessel „ecoVIT VKK 186/5" hat keinen Energieträger zugeordnet - es gilt ersatzweise Brennstoffkatalog „Erdgas E“ (kein Energieträger zugeordnet). Mit zugeordnetem Energieträger rechnet der Lauf mit dem gepflegten Wert aus dem Emissionskatalog.
      | [23:12:58] Simulation beendet, Ergebnis-Kopf-ID 214.
      | [23:12:58] Projekt 1023: 25 CSV-Dateien, 141 Skalare.
Projekt 1023: OK, 25 CSV-Dateien, 00:01
--- Projekt 1024 (Wöhler - Test2) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:12:59] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:12:59] Simulation startet fuer Projekt 1024 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Heizkessel: Emissionsfaktoren: Der Kessel „eloBLOCK VE 10" hat keinen Energieträger zugeordnet - es gilt ersatzweise Brennstoffkatalog „Elektrische Energie“ (kein Energieträger zugeordnet). Mit zugeordnetem Energieträger rechnet der Lauf mit dem gepflegten Wert aus dem Emissionskatalog.
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | [23:12:59] Simulation beendet, Ergebnis-Kopf-ID 215.
      | [23:12:59] Projekt 1024: 26 CSV-Dateien, 167 Skalare.
Projekt 1024: OK, 26 CSV-Dateien, 00:01
--- Projekt 1026 (Beispiel WP WG 1) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:00] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:00] Simulation startet fuer Projekt 1026 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 0.000 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [23:13:01] Simulation beendet, Ergebnis-Kopf-ID 216.
      | [23:13:01] Projekt 1026: 29 CSV-Dateien, 142 Skalare.
Projekt 1026: OK, 29 CSV-Dateien, 00:01
--- Projekt 1028 (Beispiel WP WG mit Erdwärme) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:01] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:02] Simulation startet fuer Projekt 1028 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 0.000 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [23:13:02] Simulation beendet, Ergebnis-Kopf-ID 217.
      | [23:13:02] Projekt 1028: 29 CSV-Dateien, 142 Skalare.
Projekt 1028: OK, 29 CSV-Dateien, 00:01
--- Projekt 1029 (Beispiel WP WG 1 - Erdwärme) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:03] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:03] Simulation startet fuer Projekt 1029 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 0.000 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [23:13:04] Simulation beendet, Ergebnis-Kopf-ID 218.
      | [23:13:04] Projekt 1029: 29 CSV-Dateien, 157 Skalare.
Projekt 1029: OK, 29 CSV-Dateien, 00:01
--- Projekt 1030 (Referenz BHKW-Kaskade (Regressionstest)) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:04] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:05] Simulation startet fuer Projekt 1030 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | [23:13:05] Simulation beendet, Ergebnis-Kopf-ID 219.
      | [23:13:05] Projekt 1030: 22 CSV-Dateien, 160 Skalare.
Projekt 1030: OK, 22 CSV-Dateien, 00:01
--- Projekt 1039 (Wärmepumpe WG - BHKW) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:06] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:06] Simulation startet fuer Projekt 1039 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | [23:13:06] Simulation beendet, Ergebnis-Kopf-ID 220.
      | [23:13:06] Projekt 1039: 18 CSV-Dateien, 60 Skalare.
Projekt 1039: OK, 18 CSV-Dateien, 00:01
--- Projekt 1043 (Booster-Kette mit Kombi-Speicher) ---
      | Schreibnaht: freigegeben für Referenzlauf-Suite (Rechennachweis ohne Lizenz)
      | [23:13:07] DB-Pfad der App verifiziert: K:\m7\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [23:13:07] Simulation startet fuer Projekt 1043 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [23:13:07] Simulation beendet, Ergebnis-Kopf-ID 221.
      | [23:13:07] Projekt 1043: 34 CSV-Dateien, 202 Skalare.
Projekt 1043: OK, 34 CSV-Dateien, 00:01

Fertig. Gesamtdauer 00:00:20
