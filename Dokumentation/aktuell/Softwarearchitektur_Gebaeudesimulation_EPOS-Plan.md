...
| **G4b** | Bauteilebene des Imports, für IFC und gbXML: `GebaeudeBauteilvorschlag` (eine Zone, Bauteilzeilen, Aufbauten samt Schichten, ohne Datenbank) mit `GebaeudeHuelleneinordnung` (die Einordnung an einer Stelle, `GebaeudeAggregation` bezieht sie); `GebaeudeZonenCtrl.VorschlagSchreiben` und `BauteilaufbauCtrl.ProjektaufbauEinfuegen`; Zielfeld `GebaeudeZielfelder.INNENFLAECHENFAKTOR`; Abschnitt „Bauteile (echte Hülle)“ in `GebaeudeImportDialog` samt `GebaeudeImportHuelle`; Schreibweg `WizardCtrl.GebaeudeZuordnungAnlegen` → `VorschlagSchreiben` und `GebaeudeImportCtrl.SchreibeHerkunft` in einem Vorgang; kein Schemaschritt | G3, G4c, G4a; nach **E44** vor der Feldphase von G4a | Importproben bestanden; **Referenzlauf unverändert**; Windows-Sichtabnahme. **Stand 25.09.2026:** gebaut und abgeschlossen (E44, E45; [Konzept](Konzept_Gebaeudesimulation_VDI6007_EPOS-Plan.md) N1.49, [Protokoll G4b](../ueberholt/Protokolle/Gebaeudesimulation/2026-09-25_G4b_Bauteilimport.md)); Referenzlauf 14/14 unverändert; offen die Windows-Sichtabnahme |
