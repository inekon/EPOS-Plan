...
Der plattformfreie Kern von EPOS-Plan: **306 `.cs`-Dateien** (168 aus iU4, dazu
...
dotnet test  ..\WP-Plan.Kern.slnf -c Release            # 2 807 Tests (Stand iU9-W12)
```
