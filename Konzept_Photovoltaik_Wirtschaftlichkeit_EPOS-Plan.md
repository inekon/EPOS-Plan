...
| **P5** | Dialog + Kennzahlen/Ergebnisspalten/Bericht (Word/Excel-Bausteine). **Teilumsetzung 26.08.2026**: `Form_PhotovoltaikVerguetung` (7 Gruppen inkl. Live-Herleitung, N3/N4-Sperrlogik, § 51-/Kappungs-Status, Vorschau aus dem EINEN Rechenweg; Designer-fähig statt programmatisch — bewusste Abweichung nach der jüngeren FK1/Ä6-Entscheidung des Kostendialoge-Konzepts), Andockknopf „Photovoltaik…“ in `UcWirtschaftlichkeit` (sichtbar nur bei PV), 52 PVW_*-Schlüssel de+en, HilfeKontext. **Offen:** Ergebnisspalten 6.4/Kennzahlzeilen (N.3: LCOE₀, EV-Quote+Autarkie, „Vorteil durch PV/a“) und Word/Excel-Bausteine — gebündelt mit P6 (die INEKON-Referenz braucht sie ohnehin zusammen) | Smoke pv5 14/14 (Vorbelegung, Sperrlogik, Statuszeilen, Roundtrip, Knopf); Layout-Sweep 120 Formulare 0 Befunde; **offen: Sichtprüfung Philipp** |
