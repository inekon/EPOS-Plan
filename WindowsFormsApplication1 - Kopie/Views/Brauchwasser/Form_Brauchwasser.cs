...
namespace WindowsFormsApplication1
{
    partial class Form_Brauchwasser : Form
    {
        ...
        private void btn_Hinzu_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * from Tab_Brauchwasser where Bezeichner='" + (string)dataGridView1.CurrentRow.Cells[0].Value + "'";
            rs.Open(sql);
        ...
        private void btn_Prozess_loeschen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DBCommand.CommandText = "DELETE Bezeichner FROM Tab_Brauchwasser WHERE Bezeichner='" + (string)dataGridView1.CurrentRow.Cells[0].Value + "'";
