...
- **Quelle ist PVGIS-TMY**, nicht DIN 4710 und nicht DWD-TRY. Abruf in `EPOS.Kern/Allgemein/SolarPVGISCalculator.cs:100 GetTMY` (Geokodierung `:212` über Nominatim). Der Ablauf steht in `EPOS.Kern/Allgemein/Import/KlimaImportAblauf.cs`.
