...
- [`Grundlagen_KWKG_Energiesteuer_Stromsteuer.md`](../aktuell/Grundlagen_KWKG_Energiesteuer_Stromsteuer.md) — Rechtsstand 18./19.08.2026 mit Quellen
- [`Allgemein/Reporting/Konzept_BHKW_Kosten_Erloese.md`](Protokolle/Reporting/Konzept_BHKW_Kosten_Erloese.md) und [`W4_Umsetzungsstand.md`](Protokolle/Reporting/W4_Umsetzungsstand.md) — die abgenommene Ausbaustufe W4
- [`Allgemein/Reporting/Analyse_Altanwendung_BHKW-Plan.md`](Protokolle/Reporting/Analyse_Altanwendung_BHKW-Plan.md) — Rechenwege und 17 Fehler der Excel-Anwendung
...
> [`FX2_Rechenwege_Befunde_Protokoll.md`](Protokolle/Reporting/FX2_Rechenwege_Befunde_Protokoll.md) § 1.
...
| **B3** | M-2 Steuerwahl und Hilfsstrom je Anlage; § 54 auf Kesselbrennstoff; Eigenstrom-Tatbestand je Anlage — **umgesetzt 30.08.2026** (Schema-Schritt 61; `B3a_SteuerwahlJeAnlage_Protokoll.md` + `B3b_Hilfsstrom_Protokoll.md`) | **ja, gewollt** bei gepflegten Angaben; ohne Pflege keine | A/B-Nachweis mit Zahlen, Handrechnung je Vorschrift, präparierte Kopie für den Kesselfall |
| **B4** | BW4: Energieintensität als eine Wahrheit; Katalog löst die Konstanten in `StromAufschlagModel` ab (Befund A7) — **umgesetzt 30.08.2026** (`B4_Energieintensitaet_Protokoll.md`; reduzierter Satz bleibt Rückfallkonstante mit vorbereitetem Katalog-Lesepfad `STROMST_REDUZIERT_SATZ`) | keine (wertgleich) | Gleichstand Katalog ↔ Aufschlagsblock gemessen |
