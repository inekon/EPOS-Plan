...
> Kandidaten für eine echte Abweichung, Monitorwechsel, Setup mit WebView2. Der vierundzwanzigste iOS-Lauf folgt auf
> diesem Stand — erstmals mit `Hauptfenster`, `Menueband` und der `AppWurzel` als gemeinsamer Wurzel (N9; Lauf 23 war
> eine abgebrochene Dublette).
