...
**Stand 07.09.2026:** **Alle neun Punkte sind geschlossen.** **W6‑O‑2** durch
...
Teillast-Regel) und der neue Punkt **W6‑O‑9** (der Ordner `VDI-3805-Daten` im Setup). Die
Tabelle führt darunter die **Anwenderentscheide zur Oberfläche**, die den Wechselrichter
betreffen, ohne offener Punkt gewesen zu sein — bislang einer: **W16c‑E‑7**.
