...
| `Zapfprofil.Validierung.Band.Unten` | 0,95 | – | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:37`; Code-Vorgabe `EPOS.Kern/Allgemein/Zapfprofil/Messvergleich.cs:207` | N15 (e): untere Bandgrenze der synthetischen Dauerlinie, unter der die Messspitze als „unterhalb" gilt; ZU35/N32: P95 aus der Bandanalyse des zweiten Validierungslaufs, Herkunftsart `EIGENKONSTRUKTION` | bestätigt 26.09.2026 (0,85); **geändert 26.09.2026 nach ZU35: 0,95** |
| `Zapfprofil.Validierung.Band.Oben` | 0,999 | – | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:38`; Code-Vorgabe `EPOS.Kern/Allgemein/Zapfprofil/Messvergleich.cs:210` | N15 (e): obere Bandgrenze der synthetischen Dauerlinie; ZU35/N32: P99,9, Herkunftsart `EIGENKONSTRUKTION` | bestätigt 26.09.2026 (0,95); **geändert 26.09.2026 nach ZU35: 0,999** |
| `Zapfprofil.Validierung.Band.MindestEinheiten` | 10 | – | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:39`; Code-Vorgabe `EPOS.Kern/Allgemein/Zapfprofil/Messvergleich.cs:218`; Bereich 1 … 10 000 (`TwwParameterschluessel`) | ZU35/N32: kleinste Zahl der Einheiten (Summe der Bezugsmengen), ab der das Band bewertet wird; darunter „nicht bewertbar" (gelb). Herkunftsart `EIGENKONSTRUKTION` | **neu 26.09.2026 nach ZU35: 10** |
| `Zapfprofil.Validierung.Formschwelle` | 0,01 | – | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:10`; Code-Vorgabe `EPOS.Kern/Allgemein/Zapfprofil/Messvergleich.cs:221` | N15 (e): mittlere absolute Abweichung der 24 Stundenanteile je Tagtyp, ab der die Form als abweichend gilt | bestätigt 26.09.2026 |
| `Zapfprofil.Validierung.Lueckenanteil` | 0,05 | – | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:11`; Schlüssel `EPOS.Kern/Allgemein/Zapfprofil/Zapfprofileingang.cs:244` | N15 (e): höchster zugelassener Anteil gefüllter Lücken einer Messreihe, darüber Ablehnung | bestätigt 26.09.2026 |
| `Zapfprofil.Validierung.Kalibrierung.MindestTage` | 30 | d | `Referenzlaeufe/Katalogpaket_frei/Tab_TwwParameter_STAMM.csv:12`; Code-Vorgabe `EPOS.Kern/Allgemein/Zapfprofil/Messkalibrierung.cs:62` | N15 (e): kürzeste Messreihe, aus der ein Kalibriervorschlag der Nichtwohn-Parameter entsteht | bestätigt 26.09.2026 |
