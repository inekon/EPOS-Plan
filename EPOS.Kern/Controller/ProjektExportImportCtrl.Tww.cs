...
namespace WindowsFormsApplication1
{
    ...
    /// verglichen.</para>
    ///
    /// <para><b>Schemaschritt 131 (T3 „Typtage").</b> Die WAHL des Typtagwegs an
    ...
    public partial class ProjektExportImportCtrl
    {
                                         ...
                                         Dictionary<string, List<Dictionary<string, JsonElement>>> katalogzeilen)
        {
            ...
            // Schritt 131 (T3 "Typtage", Stufe Z4b): die WAHL des Typtagwegs reist mit der
            // Projektzeile - die eingespielten Typtage selbst NIE (Konzept Kapitel 6).
            TwwSpaltenschrittMelden(quellen, TwwSchema.SpaltenT3Typtage, 131);
        }
