...
namespace EPOS.Kern.Tests
{
    ...
    public sealed class ZeichenmodellWacheTests : IDisposable
    {
        ...
        /// <summary>
        /// Jede Zeichenmethode gibt ihr Modell an den Maler: 31 öffentliche
        ...
        ///
        /// <para>Die Gebäudesimulation (Stufe G2) brachte <c>Raumtemperatur</c> dazu.</para>
        ///
        /// <para>Der Zapfprofilgenerator (Stufe Z1) brachte <c>Stundenprofile</c> dazu — das
        /// Stundenprofil mit mehreren Reihen für Tagesgang und Wochenprofil.</para>
        ///
        ...
        ///
        /// <para>ETAPPE E8a der Wirtschaftlichkeit brachte <c>KapitalwertBruecke</c> dazu —
        /// das Brückenbild von der Investition zur Kapitalwertdifferenz (U41).</para>
        /// </summary>
        [Fact]
