...
- Seit 26.09.2026: Ist an einer Anlage ein Hilfsenergieanteil angegeben, ermittelt EPOS-Plan daraus die
  Hilfsenergiekosten (Menge × Strompreis) in der Position „Hilfsenergiekosten“, sofern dort kein eigener Satz gepflegt
  ist. Der Deckungsgrad des BHKW zählt nur den selbst verbrauchten BHKW-Strom und bezieht ihn auf den gesamten
  Strombedarf. (#548)
...
- Seit 26.09.2026: Die Baualtersklassen folgen der üblichen Einteilung nach Bauzeitraum (bis 1859 bis
  ab 2021) und ergeben sich aus dem Baujahr; ein eigenes Feld nennt den Energiestandard, und der
  Gebäudekatalog enthält auch Gebäude für Neubauten ab 2021 und Altbauten bis 1859. (Gebäudesimulation,
  E47, E51)
...
Keinen eigenen Satz bekommt E51 (Katalogsätze der Klassen M und A, freier Wert nach Stein/Loga): Die
Katalogsätze gehören zum Satz der Baualtersklassen, der mit derselben Version erscheint; der freie Wert gilt
nur ohne Katalogsatz und ruht, weil jede Klasse Sätze hat — Regel 13.4, ein Thema, ein Eintrag.
...
*Zu #548 (E30):* Ein Eintrag mit zwei Sätzen — Hilfsenergiekosten aus dem Anlagenanteil (Stichwort `kosten`, Anker
`hilfsenergie-anteil`) und die Stromdeckung des BHKW als Eigenverbrauch am gesamten Strombedarf. Die Version ist beim
Anwender zu bestätigen (Vorschlag: 1.2.0.4 mit dem Sammel-Upload). Ohne eigenen Satz bleibt die Datenpflege der
Referenzprojekte 1030/1026 (Testdaten, keine Funktion). Der Fachtext der Seite „Simulationsergebnisse“ zur Stromdeckung
des BHKW ist noch nicht nachgezogen (Statusdatei, Nach #548 (f)).
...
- Seit 26.09.2026: Die Speicherauslegung Brauchwasser rechnet mit den INEKON-Vorgaben für
  Speichertemperatur, Nutzanteil, Zuschlag, Nenninhalte und Ladefenster. (#543)
