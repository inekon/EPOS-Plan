...
namespace WindowsFormsApplication1
{
    ...
    public partial class Form_Klimadaten : Form
    {
        ...
        {
            KlimaregionStammCtrl krclass = new KlimaregionStammCtrl();
            krclass.ReadAll();
        ...
        private void CreateChart()
        {
            ...
            KlimaregionStammCtrl ctrlregion = new KlimaregionStammCtrl();
            SolardatenCtrl ctrl = new SolardatenCtrl();

            ctrlregion.ReadSingle("Select * from Tab_Klimaregion_STAMM where Name = '" + m_szOrtName + "'");
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxKlimreg.SelectedIndex != -1)
            {
                ...
                if (krclass.IsReadOnly(listBoxKlimreg.Text))
                {
                    MessageBox.Show("Diese Klimaregion ist schreibgeschützt (ReadOnly) und kann nicht gelöscht werden.", "Hinweis");
                    return;
                }
        ...
        {
            KlimaregionStammCtrl ctrlklimareg = new KlimaregionStammCtrl();
