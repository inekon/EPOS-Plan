...
| Einspeiseerlös Strom | reiner Projektwert `Einspeiseverguetung_KWK` 0,0500 €/kWh (ein aktiver Rollentarif kann ihn durch seinen Einspeisepreis ersetzen; einen Zeitzonentarif gibt es nicht); kein Katalog, kein Vorschlag | KWK-Einspeisung der Strommatrix (`KwkEinspeisungGesamtMWh`) | Handeingabe ist der einzige Weg; leer oder 0 ⇒ keine KWK-Einspeiseerlöse, ohne Meldung; nominal konstant |
...
| ✔ Q11 | Der Zeitzonentarif und die Differenzmethode liefen über dieselbe Tarifstruktur; mit „kein HT/NT" stand offen, ob der Tarifdialog ganz entfällt | **umgesetzt #439** (E7 Teil b; E7b‑Q1 = b, 23.09.2026): Das Rollenmodell bleibt, die Differenzmethode dieses Papiers ist unverändert — Bezugs- und Reststromtarif, ein Einspeisepreis für PV und KWK, der Leistungsanteil an den Lastbildern der Strommatrix (Stundenmittel); die Tarifstruktur öffnet sich über „BHKW-Tarif…" und „Einspeise-Tarif…". Entfallen sind allein das Zonenmodell (Winter/Sommer × HT/NT) und der Einstieg „Strombezug…"; die zweistufige Leistungspreis-Staffel steht beim Stromträger (`04`). Die Strommatrix führt je Projekt eine Jahreszeile; ihre Mengen und damit das Beispiel dieses Papiers bleiben gleich |
