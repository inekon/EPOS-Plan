...
Erhoben beim S2-Lauf von [`sql/tools/Erzeuge-Schema.ps1`](../../../../sql/tools/Erzeuge-Schema.ps1) über die
...
Rohwerte auch in [`schema/inventar.json`](../../../../sql/schema/inventar.json) unter `Nachschlagefelder` und
