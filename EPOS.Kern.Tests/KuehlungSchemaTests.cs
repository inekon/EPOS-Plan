...
namespace EPOS.Kern.Tests
{
    ...
    public class KuehlungSchemaTests : IDisposable
    {
        ...
        public void KU_S1_haengt_die_vier_Spalten_hinter_M3_an_die_Sicht()
        {
            ...
            // Die GELTENDE Sicht ist die des letzten Sichtneubaus (KAK-S1, die vierte); sie beginnt mit den
        ...
        /// </summary>
        [Fact]
        public void Die_Testdatenbank_steht_auf_110_und_traegt_allein_die_gesaeten_Kaeltedaten()
        {
            ...
            // Die Sicht ist die GELTENDE (die des letzten Sichtneubaus, KAK-S1); die 77 Spalten von
