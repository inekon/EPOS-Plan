...
| [`ueberholt/Protokolle/KI/`](ueberholt/Protokolle/KI/) | 10 | KI-Assistent: H4/H5, H8, H10 Semantikindex, Klarnamenschutz, `KI1_Wissen_Klimadaten_Protokoll.md`, `KIF1_Erzeugermasken_Protokoll.md` (Freigabe der Erzeugermasken des Projekts, erste Welle von KI‑D‑Q5), `KIF2_Simulationskonfiguration_Protokoll.md` (Simulationskonfiguration über Sichtklassen, Ansicht Simulation mit 38 Feldern), `KIF1b_Wahlfelder_Protokoll.md` (Feldtyp „Wahl", tolerante Feldnamen, Nachzug aller Masken), `KIF3_Bedarf_Klima_Protokoll.md` (fünfzehn Masken des Bedarfs und die Klimadaten) |
| [`ueberholt/Protokolle/Views/`](ueberholt/Protokolle/Views/) | 7 | Projektdialoge P1–P6, das Redesign „Berichte & Kosten", `MN1_Administrationsmenue_Protokoll.md` (Menüordnung, Lizenzdialog unter Hilfe, Gesetzeskatalog mit Katalogliste), `PI1_Projekttransfer_Mehrfach_Protokoll.md` (Mehrfachauswahl im Export, Sammellauf im Import) und `GM1_Geraetemeldungen_Protokoll.md` (Klimaregionenliste nach dem Klimadaten-Dialog, Auswahlfeld über dem Menüband, Schalter „sortiert" auf Solarthermie und Photovoltaik) |
| [`ueberholt/Protokolle/Update/`](ueberholt/Protokolle/Update/) | 5 | Anlagenzeilen-Eindeutigkeit (Schritt 17), die E6-Quellensaat, der Projekt-Fremdschlüssel (Schritt 96) und die zwei Schritte am BHKW-Wirkungsgrad (98: Faktor, 99: elektrischer und thermischer Anteil) |
