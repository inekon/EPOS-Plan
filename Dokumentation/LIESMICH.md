...
| [`ueberholt/Protokolle/Simulation/`](ueberholt/Protokolle/Simulation/) | 62 | Simulationskern: Pakete 1–9, A/B, Quellen/Senken, Dreikanal, Kaskade, Booster, Schichtspeicher, die Speicherklammer der Wärmesenke, die Merge-Protokolle und die Bestandsbefunde; dazu `Konzept_Simulation_QuellenSenken.md` und `Konzept_Brauchwasser_Heizung_Pufferspeicher.md` (beide umgesetzt) |
