        ...
        private void btn_Uebernehmen_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < datlines.Count; i++)
            {
                ...
                else if(anfang && (token[0] == "710.91"))
                {
                    ...
                    if(!wpctrl.InsertKenndatenStamm(datctrl.m_ID_WP, datctrl.m_nVorlauf, datctrl.m_nTemperatur, datctrl.m_nCOP, datctrl.m_nPTherm)) return;
                }
                else if (anfang_kuehl && (token[0] == "710.91"))
                {
                    ...
                    if (!wpctrl.InsertKenndatenKuehlungStamm(datkuehlctrl.m_ID_WP, datkuehlctrl.m_nVorlauf, datkuehlctrl.m_nTemperatur, datkuehlctrl.m_nCOP, datkuehlctrl.m_nPkuehl, datkuehlctrl.m_nLast)) return;
                }
