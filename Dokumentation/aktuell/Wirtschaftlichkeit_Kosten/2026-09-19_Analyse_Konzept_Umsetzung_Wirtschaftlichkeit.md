...
`485052c6` · `SchemaStand.Zielversion` = **113**, Schemaschritte 90–113 vergeben (105 = K‑1, #440; 108–110 =
...
> **Nachtrag 23.09.2026 (#432 bis #454).** Gebaut sind inzwischen auch **E4** (#432), **E5** (#434),
...
> wird" und die Fußzeile, ohne Rechenwirkung; die vier Fragen E8a‑Q1 bis E8a‑Q4 am 23.09.2026 entschieden); der
> Schnitt **A13** ist mit #435 ausgeführt. **Nächste Etappe: E8 Teil b.** Die Schemaschritte sind am 23.09.2026 neu geordnet (§ 6):
...
Teil a — umgesetzt #454** (Einzelheiten in der Tafel oben, in den Statuszeilen und ihren Protokollen) — **E7 ist
abgeschlossen**, von E8 die ValERI-Ansicht (V‑C) mit allen fünf Blöcken samt Block 2 und Zahlungsstrombild U42,
Nominalsummen, Brückenbild, „Was daraus im Lauf wird", Fußzeile (U41/U46–U48) und E6‑Q1; der **A13-Schnitt** ist mit
#435 ausgeführt. **Nächste Etappe:** **E8 Teil b** (die Formelmappe Stufen 0 bis 3, die Anhang-E-Checkliste U43,
die Anhang-D-Gegenprobe; vorab die ClosedXML-Fragen aus `05/§ 3.3`), danach **E9**; die acht Fragen aus E7c3 sind
offen. **E8 Teil b bis E12** bleiben offen, E11 entfällt.
...
`SchemaStand.Zielversion` steht auf **113**; der **nächste freie Schritt ist 114**.
