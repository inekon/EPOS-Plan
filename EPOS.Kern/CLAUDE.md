...
Der plattformfreie Kern von EPOS-Plan: **310 `.cs`-Dateien** (168 aus iU4, dazu
...
dotnet test  ..\WP-Plan.Kern.slnf -c Release            # 2 972 Tests (Stand iU9-W13)
```
