...
[`schema/inventar.json`](../../../../sql/schema/inventar.json) unter `PkGewechselt` (je Tabelle mit Access-PK,
...
| Datei | Größe | Inhalt |
|---|---:|---|
| [`sql/tools/Erzeuge-Schema.ps1`](../../../../sql/tools/Erzeuge-Schema.ps1) | 41.836 B | Generator (PowerShell 7, DAO 120) |
| [`sql/tools/baue_leere_db.py`](../../../../sql/tools/baue_leere_db.py) | 13.971 B | Aufbau der leeren DB + 25 Abnahmeproben |
| [`sql/schema/001_grundschema.sql`](../../../../sql/schema/001_grundschema.sql) | 80.834 B | 114 × `CREATE TABLE … STRICT` inkl. PK und 88 FK |
| [`sql/schema/002_views.sql`](../../../../sql/schema/002_views.sql) | 8.491 B | 14 Views (2 übersetzt, 12 unverändert) |
| [`sql/schema/003_indizes_fk.sql`](../../../../sql/schema/003_indizes_fk.sql) | 25.664 B | 260 × `CREATE [UNIQUE] INDEX` |
| [`sql/schema/SchemaTypKatalog.g.cs`](../../../../sql/schema/SchemaTypKatalog.g.cs) | 3.420 B | 61 Bool- + 11 Datumsnamen für S4 |
| [`sql/schema/typkatalog.json`](../../../../sql/schema/typkatalog.json) | 7.744 B | dasselbe mit Tabelle→Spalten-Zuordnung |
| [`sql/schema/inventar.json`](../../../../sql/schema/inventar.json) | 981.103 B | vollständiges Strukturinventar + Zählungen |
