...
namespace EPOS.Kern.Tests
{
    ...
    public class SimulationErgebnisCtrlTests : IClassFixture<TestDatenbank>
    {
        ...
        public void Uebersicht_fuehrt_die_vier_Groessen_der_Huelle_zahlengleich()
        {
            ...
            // Der Zaehler des Strom-Rings — in der Huelle: StromgedecktMwh(). E30/3 (#544,
            ...
            Assert.Equal(l.sim.simulation_bhkw.Stromproduktion_BHKW_MWh
                         - SimulationErgebnisCtrl.BhkwEinspeisungMwh(l.sim),
                         u.BhkwStromEigenverbrauchMwh, 9);
            Assert.True(u.BhkwStromEigenverbrauchMwh < u.BhkwStromproduktionMwh);
