    ...
    internal static class PufferSpProjektHuelle
    {
            ...
            int idProjekt, string verwendung, int idPuffer)
        {
            return new Dictionary<string, object>
            {
                ...
                ["LabelEntnahmeHeizung"] = MyResource.Resource.PSP_LABEL_ENTNAHME_HEIZUNG,
                ["LabelEntnahmeBW"] = MyResource.Resource.PSP_LABEL_ENTNAHME_BW,
                ["LabelEntnahmeProzess"] = MyResource.Resource.PSP_LABEL_ENTNAHME_PROZESS,
