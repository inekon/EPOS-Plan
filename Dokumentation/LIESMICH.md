...
| [`ueberholt/Protokolle/Bericht/`](ueberholt/Protokolle/Bericht/) | 4 | `LIESMICH_Phase1.md` — Phasen-Historie des Berichtsmoduls; `DG_E1x_Zeichenmodell_Protokoll.md` — Etappe E1 des Diagrammkonzepts: das Zeichenmodell hinter dem `ChartRenderer` (E1a Modell, Maler, Farbrollen, Skala und die 15 Zeitreihenbilder; E1b und E1c folgen); `DG_E2_SvgBaustein_Protokoll.md` — Etappe E2: die SVG-Ausgabe desselben Modells (`SvgSchreiber`, `JahresgangModell`, Pfadregel und Marken; der Abschnitt zur Oberfläche folgt); `DG_E3_Rollout_Protokoll.md` — Etappe E3, der Rollout je Diagrammart (Gruppe (a): die sieben Zeitreihen-Modelle der Ergebnisreiter samt Bildpunkt-Senkrechter, Flächen und Fensterpfad; dazu der Oberflächenteil — zwölf Bilder im Baustein `DiagrammSvg`, zweite y-Achse, Nachladen ab dem Vierfachen und der Wegfall des Rundlauf-Datenzooms) |
