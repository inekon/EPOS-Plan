...
{
    /// <summary>
    /// ETAPPE E7c — <b>Schritt F (Schemaschritt 108): die Preisbasis der Trägerkarte als
    ...
    {
        [Fact]
        public void Der_Zielstand_ist_108_und_der_Schritt_hat_eine_Textspalte()
        {
            Assert.True(SchemaStand.Zielversion >= 108,
                        "Zielstand " + SchemaStand.Zielversion + " liegt unter 108.");

            SchemaSpalte[] spalten = SchemaKatalog.Schritt108_Preisbasis;
        ...
        /// weiter auf kWh; vor Schritt 108 fiel sie auf die Abrechnungseinheit zurück.
        /// </summary>
        [Fact]
