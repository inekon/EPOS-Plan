...
> `vor-W16` (R‑W16‑6, nur auf Windows). Der einundzwanzigste iOS-Lauf folgt auf diesem Stand — erstmals mit dem
> Assistenten hinter `AssistentGaben` in der `AppWurzel` (N9).
