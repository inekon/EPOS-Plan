...
| VDI-4655-Anker (neu V1.2) | Jahresenergie EFH = 520·N_Pers kWh, MFH = 970·N_WE kWh **bei angeglichener Bilanzgrenze** (Zirkulation inkl., Speicher exkl.); Prüfsumme Σ n_TT·F_TWE,TT ≈ 0; F_TWE,SWX = 0 gesetzt; Sommer-Heizlast = reines TWW; Beispielrechnung Abschnitt 8 (EFH 113 m², 3 Pers., TRY05, Q_TWE,a 1560 kWh) als Regressionstest | Anker ±Toleranz; stochastische Streuung SOLL breiter sein als VDI-Tagesband (−18 %/+37 %) |
