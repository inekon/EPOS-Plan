...
Der plattformfreie Kern von EPOS-Plan: **313 `.cs`-Dateien** (168 aus iU4, dazu
...
dotnet test  ..\WP-Plan.Kern.slnf -c Release            # 3 259 Tests (Stand iU9-W14a/W14b)
```
