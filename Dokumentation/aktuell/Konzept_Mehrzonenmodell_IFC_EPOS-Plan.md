...
frühere Stufe unberührt bleibt. Die Prüfung dafür ist hart und steht in Kapitel 8: alle dreizehn
...
| Ebene | Regel |
|---|---|
| Zone | `Nutzflaeche > 0`, `Raumhoehe > 0`, `Volumen > 0`; Solltemperaturen 5…40 °C; `Maximaleraumtemperatur` ≥ Tagessollwert; Luftwechsel 0…10 1/h; höchstens 50 Zonen je Gebäude (2.9, M12) |
...
(unterschiedliche Randbedingungen an Boden und Dach).
...
Einzonenrechnung.** **Ohne Stoffwerte** gilt 3.6: masselos mit U-Wert, Masse aus `Bauweise`, je
Zone entschieden.
