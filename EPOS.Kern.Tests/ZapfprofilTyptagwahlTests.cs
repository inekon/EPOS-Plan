...
namespace EPOS.Kern.Tests
{
    ...
    /// N14 (i); Schemaschritt T3 „Typtage", Schritt 125, Stufe Z4b, Gruppe 2): Sie steht in
    ...
    /// Datenbank vor 125 lehnt eine gesetzte Wahl benannt ab, läuft aber ohne Wahl durch.
    ///
    ...
    public sealed class ZapfprofilTyptagwahlTests
    {
        ...
        public void Die_Wahl_wird_gespeichert_und_gelesen()
        {
            ...
            Assert.True(TwwSchema.T3TyptageVollstaendig(), "Die Kopie steht nicht auf Schritt 125.");
        ...
        [Fact]
        public void Vor_Schritt_125_laeuft_das_Speichern_ohne_Wahl_durch_und_lehnt_eine_Wahl_ab()
        {
