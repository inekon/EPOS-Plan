...
namespace WindowsFormsApplication1
{
    ...
    public class AccessRepository
    {
                                        ...
                                        DbVorgang v)
        {
            ...
            try
            {
                bool istKlimadaten = tabelle.StartsWith("Tab_Klimadaten");
                // Tab_Solar_STAMM fuehrt den Regions-Fremdschluessel als Spalte "Bezeichner" (nicht ID_Klimaregion).
               // bool istSolarStamm = (tabelle == "Tab_Solar_STAMM");
               // string fkCol = istSolarStamm ? "Bezeichner" : "ID_Klimaregion";
