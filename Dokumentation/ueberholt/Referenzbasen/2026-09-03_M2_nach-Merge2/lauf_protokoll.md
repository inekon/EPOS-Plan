...
**Zeitpunkt:** 03.09.2026 10:50:37

**Quelle (produktiv, nur gelesen):** `P:\pa0\Quelle\Kenndaten.sqlite`

**Arbeitskopie (beschrieben):** `P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite`

**Zielordner:** `P:\wt2\Referenzlaeufe\2026-09-03_M2_nach-Merge2`
...
Arbeitskopie angelegt: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite (64 MB)
DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite

Schema-Migration der Arbeitskopie ...
  P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
  Zeitpunkt: 03.09.2026 10:50:27
...
--- Projekt 1007 (Laurentiuskirche) ---
      | [10:50:28] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:28] Simulation startet fuer Projekt 1007 ...
      ...
      | [10:50:28] Simulation beendet, Ergebnis-Kopf-ID 208.
      | [10:50:28] Projekt 1007: 29 CSV-Dateien, 99 Skalare.
Projekt 1007: OK, 29 CSV-Dateien, 00:00
--- Projekt 1008 (Heinestr 15) ---
      | [10:50:29] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:29] Simulation startet fuer Projekt 1008 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:29] Simulation beendet, Ergebnis-Kopf-ID 209.
      | [10:50:29] Projekt 1008: 21 CSV-Dateien, 101 Skalare.
Projekt 1008: OK, 21 CSV-Dateien, 00:00
--- Projekt 1011 (test1) ---
      | [10:50:29] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:29] Simulation startet fuer Projekt 1011 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [10:50:30] Simulation beendet, Ergebnis-Kopf-ID 210.
      | [10:50:30] Projekt 1011: 29 CSV-Dateien, 121 Skalare.
Projekt 1011: OK, 29 CSV-Dateien, 00:00
--- Projekt 1017 (WP_PV-Speicher) ---
      | [10:50:30] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:30] Simulation startet fuer Projekt 1017 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:30] Simulation beendet, Ergebnis-Kopf-ID 211.
      | [10:50:30] Projekt 1017: 21 CSV-Dateien, 114 Skalare.
Projekt 1017: OK, 21 CSV-Dateien, 00:00
--- Projekt 1018 (BHKW Test München) ---
      | [10:50:31] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:31] Simulation startet fuer Projekt 1018 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:31] Simulation beendet, Ergebnis-Kopf-ID 212.
      | [10:50:31] Projekt 1018: 22 CSV-Dateien, 141 Skalare.
Projekt 1018: OK, 22 CSV-Dateien, 00:00
--- Projekt 1021 (TestSpeichernUnter) ---
      | [10:50:31] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:31] Simulation startet fuer Projekt 1021 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:31] Simulation beendet, Ergebnis-Kopf-ID 213.
      | [10:50:31] Projekt 1021: 21 CSV-Dateien, 94 Skalare.
Projekt 1021: OK, 21 CSV-Dateien, 00:00
--- Projekt 1023 (Wöhler - Test1) ---
      | [10:50:32] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:32] Simulation startet fuer Projekt 1023 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:32] Simulation beendet, Ergebnis-Kopf-ID 214.
      | [10:50:32] Projekt 1023: 25 CSV-Dateien, 136 Skalare.
Projekt 1023: OK, 25 CSV-Dateien, 00:00
--- Projekt 1024 (Wöhler - Test2) ---
      | [10:50:32] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:32] Simulation startet fuer Projekt 1024 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | [10:50:32] Simulation beendet, Ergebnis-Kopf-ID 215.
      | [10:50:33] Projekt 1024: 26 CSV-Dateien, 157 Skalare.
Projekt 1024: OK, 26 CSV-Dateien, 00:00
--- Projekt 1026 (Beispiel WP WG 1) ---
      | [10:50:33] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:33] Simulation startet fuer Projekt 1026 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 9.014 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [10:50:33] Simulation beendet, Ergebnis-Kopf-ID 216.
      | [10:50:33] Projekt 1026: 29 CSV-Dateien, 137 Skalare.
Projekt 1026: OK, 29 CSV-Dateien, 00:00
--- Projekt 1028 (Beispiel WP WG mit Erdwärme) ---
      | [10:50:34] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:34] Simulation startet fuer Projekt 1028 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: Wärmepumpe 'CS6800iAW MB + AW 10 OR-T': Die Quelltemperatur überschreitet in 957 Stunden die obere Stützstelle der Kennlinie (20,0 °C). Für diese Stunden gilt der COP der obersten Stützstelle; es wird nicht extrapoliert. Liefert der Hersteller ein Hochtemperatur-Kennfeld, sollte die Kennlinie um höhere Stützstellen ergänzt werden.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 9.014 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [10:50:34] Simulation beendet, Ergebnis-Kopf-ID 217.
      | [10:50:34] Projekt 1028: 29 CSV-Dateien, 137 Skalare.
Projekt 1028: OK, 29 CSV-Dateien, 00:00
--- Projekt 1029 (Beispiel WP WG 1 - Erdwärme) ---
      | [10:50:34] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:35] Simulation startet fuer Projekt 1029 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": T_NOCT ist mit 9.014 Grad C nicht plausibel (erwartet werden 20 bis 60 Grad C). Gerechnet wird mit dem Rueckfall 45 Grad C. Der Wert laesst sich im Modulkatalog pflegen.
      | Simulation Hinweis: PV-Modul "Jinkosolar JKM 260P-60": Es ist kein Temperaturgang hinterlegt (gamma_PMP = 0). Die Anlage rechnet damit ohne jeden Temperatureinfluss - reale Module verlieren rund 0,3 bis 0,45 % Leistung je Kelvin.
      | Simulation Hinweis: Dem Projekt ist kein Strom-Energietraeger zugeordnet - es gelten die Vorgabewerte fuer Aufschlag und Verguetung. Fuer den Strombezug ist kein Arbeitspreis gepflegt - gerechnet wird mit dem Rueckfallwert 20 ct/kWh.
      | [10:50:35] Simulation beendet, Ergebnis-Kopf-ID 218.
      | [10:50:35] Projekt 1029: 29 CSV-Dateien, 152 Skalare.
Projekt 1029: OK, 29 CSV-Dateien, 00:00
--- Projekt 1030 (Referenz BHKW-Kaskade (Regressionstest)) ---
      | [10:50:35] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:35] Simulation startet fuer Projekt 1030 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | [10:50:36] Simulation beendet, Ergebnis-Kopf-ID 219.
      | [10:50:36] Projekt 1030: 22 CSV-Dateien, 150 Skalare.
Projekt 1030: OK, 22 CSV-Dateien, 00:00
--- Projekt 1039 (Wärmepumpe WG - BHKW) ---
      | [10:50:36] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:36] Simulation startet fuer Projekt 1039 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      | [10:50:36] Simulation beendet, Ergebnis-Kopf-ID 220.
      | [10:50:36] Projekt 1039: 18 CSV-Dateien, 60 Skalare.
Projekt 1039: OK, 18 CSV-Dateien, 00:00
--- Projekt 1043 (Booster-Kette mit Kombi-Speicher) ---
      | [10:50:36] DB-Pfad der App verifiziert: P:\merge2\src\Referenzlaeufe\Arbeitskopie\Kenndaten.sqlite
      | [10:50:36] Simulation startet fuer Projekt 1043 ...
      | Simulation Hinweis: Zeitbasis Klimadaten: UTC -> MEZ/MESZ, Referenzjahr 2025, Umstellung 30.03./26.10..
      ...
      | [10:50:37] Simulation beendet, Ergebnis-Kopf-ID 221.
      | [10:50:37] Projekt 1043: 34 CSV-Dateien, 197 Skalare.
