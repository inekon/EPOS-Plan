...
| 2 | Startbild → **Prozesswärme** → „Simulation" | Sieben Kennzahlen, „davon Brauchwasser" OHNE Teiler 1000; zwei Optionsgruppen, die sich NICHT gegenseitig umschalten; Säulen rot bzw. blau |
| 3 | Startbild → **Brauchwasser** → „Berechnen" | Titel trägt „ - ‹Name›"; Startreiter „Grafik" UND Brauchwassersicht; „Wärmebedarf Brauchwasser" MIT Teiler 1000; der Schalter „Jahresverlauf" erscheint nur hier und zeigt 8 760 Stunden über Monatsgrenzen |
...
| 13 | Die drei **Admin-Masken** (W14b) → alle Knöpfe | Besonders `Form_Brauchwasser_Admin` → „Ergebnisse Verbrauch": Dort öffnet sich wie bisher die PROZESS-Ansicht ohne Brauchwassersicht (Befund W8‑B3) |
...
| **W8‑O‑5** | Der Brauchwasserwert wird NUR in der Brauchwassermaske durch 1000 geteilt (`Form_ErgBrauchwasserwaerme.Init`:36 gegen `Form_ErgProzesswaerme.Init`:32) — dieselbe Größe, zwei Anzeigen | Wörtlich übernommen. **Entscheid des Anwenders**, welche der beiden Anzeigen richtig ist; eine davon ist um den Faktor 1000 daneben |
