...
Anzulegender Wert (EegSatzRechner)
  ...
  EV_fest    = max(0, AW_ungerundet − 0,40)       nur ≤ 100 kW ; UNGERUNDET — der ungerundete Mix
               ...
               denselben Satz nimmt die Speicherbewertung (VpvCtKwh, E7c2‑Q5 b)
...
| U36 | Die Warnzeile „über 2 MW: Stromsteuer prüfen" konnte nie erscheinen — die 1-MW-Prüfung griff zuerst | gebaut: `Anlagenwarnungen` prüft jede Schwelle für sich, beide Banner stehen nebeneinander; die Grenzen kommen aus dem Gesetzeskatalog (`EEG_AUSSCHREIBUNG_GRENZE_KW`, `STROMST_GRENZE_BEFREIUNG_9_1_3_KW`) statt aus nackten Zahlen im Dialog |
| V-G5 | Jahresmarktwert, PPA-/DV-Preise: Best/Worst-Paar je Feld | Szenarioabdeckung (Konzept § 2.11.5), Etappe **V-E** ≡ **E9** des Etappenplans; **ohne Degradation je Position** (Entscheid A5 vom 20.09.2026) — die Ertragsdegradation dieses Dialogs bleibt davon unberührt |
...
| ✔ V-1 · V-2 | EV-Rundung: der EV-Mix wurde über dem schon gerundeten AW-Mix ein zweites Mal gerundet, der Erlös blieb ungerundet · § 51a bewertete auch bei fester Vergütung mit dem AW statt mit der EV | **umgesetzt #446** (E7c2, A4): EV-Mix ungerundet, gerundet allein der Erlös auf Cent; § 51a bei fester Vergütung mit der Einspeisevergütung, in der Direktvermarktung mit dem AW; der § 51a-Betrag bleibt ungerundet (E7c2‑Q6). `PvErloesRechnerEegTests` neu gepinnt, die Marktprämie (#380) gleich. Proben mit fester Vergütung: 1040 Erlös Jahr 1 139,832 → 139,83 €, § 51a 18,39 → 17,48 €; 1045 § 51a 6,48 → 6,16 €; 1046 § 51a 7,21 → 6,85 €; Rechner 100 kWp Jahr 1 3.207,96 → 3.209,02 €, § 51a 427,60 → 401,13 €. Das Beispiel dieses Papiers (300 kWp, Direktvermarktung) bleibt unverändert. **Der Satz der Speicherbewertung `VpvCtKwh` ist umgesetzt #452** (E7c3/3, E7c2‑Q5 b): bei fester Vergütung derselbe ungerundete Satz wie die Erlösreihe — Rechner (Inbetriebnahme 08/2026) 30 kWp 7,01 → 7,006667, 100 kWp 6,03 → 6,032, 750 kWp 5,52 → 5,518933, Volleinspeisung 40 kWp 10,74 → 10,735 ct/kWh; der Override bleibt, die Marktprämie rechnet mit dem gerundeten anzulegenden Wert; kein Basisprojekt betroffen |
