...
> steht in [`BETRIEB_SQLITE.md`](../aktuell/BETRIEB_SQLITE.md), Abschnitt 1, 1.1 und 7.
...
analog zu
[`Lokalisierung_Pruefung.md`](../aktuell/Lokalisierung_Pruefung.md).
...
**Nebenbefund:** Die aus [`KONTEXT_Importkodierung_ANSI.md`](../aktuell/KONTEXT_Importkodierung_ANSI.md)
