...
- **Stand der Abdeckung.** Angemeldet sind alle Masken mit Einstellwerten bis auf drei: Zapfprofilgenerator,
  ...
  in der Zapfprofil-Sitzung umgebaut). Draußen mit Vermerk in der Eingabebilanz bleiben daneben die Zahlenfolgen
  (Monatswerte eines Bedarfstyps, Kurven des Gebäudetyps, Stundenwerte eines Kostenprofils, Profil- und
  Leistungspreisreihen) — sie brauchen die Rahmenerweiterung für Zahlenfolgen — und, mit Stufe 3, die Rechenweg-Wahl
  der Bedarfsprofile. **Führt eine Maske Felder als Daten eines Profils** (die Verwaltungen, „Alle Daten" der
