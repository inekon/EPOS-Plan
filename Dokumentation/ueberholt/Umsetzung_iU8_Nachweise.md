...
Paket iU8 des [`Umsetzungskonzept_iOS_EPOS-Plan.md`](../aktuell/Umsetzungskonzept_iOS_EPOS-Plan.md) (§ 4) ist
...
- [ ] Anwenderentscheidung: Online-Bootstrapper (heute, ~2 MB), Standalone-Installer (~150 MB,
      ...
      [`Setup/Konzept_Setup_InnoSetup_EPOS-Plan.md`](../aktuell/Konzept_Setup_InnoSetup_EPOS-Plan.md),
      Abschnitt 5.5.
