        ...
        private sealed partial class Lauf
        {
            ...
            private void FuelleDiagramm(Bildstelle b, Vorlagenfeld feld, Platzhalter m)
            {
                ...
                if (w.Diagramm != null)
                {
                    ...
                    if (modell != null)
                    {
                        A.Blip neu = Wordbilder.BaueBlip(b.Teil.Teil, SkiaMaler.Png(modell), SkiaMaler.Drucksvg(modell));
            ...
            private void FuelleDiagrammImAbsatz(OpenXmlElement bezug, Teilinfo ti, Entscheid e)
            {
                ...
                if (w.Diagramm != null)
                {
                    ...
                    if (modell != null)
                    {
                        A.Blip blip = Wordbilder.BaueBlip(ti.Teil, SkiaMaler.Png(modell), SkiaMaler.Drucksvg(modell));
