...
| O-7 | ~~Neue Referenzbasis einfrieren~~ **ERLEDIGT 27.08.2026**: Basis **`Referenzlaeufe\2026-08-27_V0`** (9/9, Selbstvergleich 9/9 PASS und **216/216 byte-/MD5-gleich**, `pruefen` plausibel; vor dem Lauf drei verwaiste fensterlose MSACCESS-Prozesse beendet und die verwaiste `laccdb` bereinigt — die produktive DB blieb unangetastet, Zeitstempel 26.08. 23:39). Der neue V0-9-Kappungshinweis meldet in 1024 real 957 Stunden. **Offen bleiben** die vier neuen Referenzprojekte aus Konzept 11.1 (Mehrgebäude; zwei Puffer je Kanal; Prozesswärme mit eigenem Puffer; Booster-Kette mit Kombi-Speicher) — sie brauchen Projektdaten des Anwenders | vor K1 (Restpunkt: 4 Projekte) |
