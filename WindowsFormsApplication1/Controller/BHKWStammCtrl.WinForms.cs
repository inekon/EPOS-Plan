...
{
    /// <summary>
    /// Der OBERFLAECHENTEIL von <see cref="BHKWStammCtrl"/> (Umsetzungskonzept iU3, Schritt 2).
    ///
    ...
    /// <c>BHKWStammCtrl</c> <c>System.Windows.Forms</c> brauchte. Der Kern verlinkt diese
    /// Datei nicht; unter Windows aendert sich nichts, weil beide Teile dieselbe Klasse
    /// bilden.</para>
    /// </summary>
    partial class BHKWStammCtrl
    {
