...
**[`ADR-001_Schema-Ausrollung.md`](../../../aktuell/ADR-001_Schema-Ausrollung.md)** (angenommen
...
**Die Ausrollung ist in [`ADR-001_Schema-Ausrollung.md`](../../../aktuell/ADR-001_Schema-Ausrollung.md)
...
| B0-12 | **Kesselanzahl ungeprüft gegen Arraygrößen** *(neu 14.08.2026, Fund der adversarialen B0-Review)*. `Anzahl = spk_list.Count` lief ohne Prüfung gegen die fest auf `MAX_SPK` (10) dimensionierten Kessel-Arrays; `Gasspitze_Kessel` in `Heizkessel_Simulation` war zusätzlich nur `double[5]`, wurde aber mit dem Kesselindex indiziert | `SimulationSPK.cs:100`, `:234` | Ab dem 6. Kessel `IndexOutOfRangeException` bei der Gasspitzenberechnung, ab dem 11. Überlauf aller Kessel-Arrays. Fix: `Anzahl` wird mit Hinweismeldung auf `MAX_SPK` begrenzt, `Gasspitze_Kessel` auf `MAX_SPK` dimensioniert |
...
[ADR-001](../../../aktuell/ADR-001_Schema-Ausrollung.md) (angenommen 14.08.2026) ist die Klasse
