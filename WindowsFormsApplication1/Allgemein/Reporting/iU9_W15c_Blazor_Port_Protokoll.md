...
| **W15c‑O‑2** | **Ein `LizenzTexte`-Bündel.** Die zwei großen Komponenten tragen ihre Anzeigetexte als 25 bzw. 20 Einzelparameter. Ein Bündel wie `KiChatTexte` (W15b) würde beide unter 350 Zeilen bringen; das ist eine Aufräumarbeit, keine Fachänderung. **Entschieden 04.09.2026 (Empfehlung angenommen):** umsetzen **nach W16** als eigener Commit, mit den 54 Dialogfällen als Netz — solange der Rahmen der Welle 16 an den Hüllen arbeitet, nicht parallel. |
