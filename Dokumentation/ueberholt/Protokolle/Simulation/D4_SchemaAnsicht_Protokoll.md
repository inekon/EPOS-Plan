...
| `MyResource/Resource.resx`, `Resource.en-US.resx`, `Resource.Designer.cs` | — | **23 neue Schlüssel** (Nachtrag in [`Lokalisierung_Katalog.md`](../../../aktuell/Lokalisierung_Katalog.md)); Bestand jetzt **640** `<data>`-Einträge je Datei |
