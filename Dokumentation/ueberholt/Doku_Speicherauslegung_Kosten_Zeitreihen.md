...
> **Aktueller Mehrspeicherstand (11.09.2026):** Die vollständige physische Flottenrechnung, Prognoseplanung, Mehrjahresbewertung und begrenzte gemeinsame Auslegung sind inzwischen umgesetzt. Konzept, Code-Zuordnung, Eingabeverträge, neue Testbelege und bekannte Grenzen stehen in [Mehrspeicher: Konzept, Umsetzung und Prüfumfang](../aktuell/Doku_Mehrspeicher_Konzept_und_Umsetzung.md). Der folgende Text bleibt als datierte Dokumentation der zuvor fertiggestellten Einzelspeicherauslegung erhalten; seine damalige Aussage „weiterführendes Konzept“ beschreibt nicht den heutigen Mehrspeicherstand.
