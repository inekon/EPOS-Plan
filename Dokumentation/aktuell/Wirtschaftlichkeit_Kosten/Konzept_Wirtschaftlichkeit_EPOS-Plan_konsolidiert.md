...
| **E14** — Formelmappe je Szenario | Stufe 1 und 2 der Formelmappe für Günstig und Ungünstig aus dem eigenen Parametersatz (Befund 1 aus E9a): Mehrjahrestabellen bis zum längsten Zeitraum mit Schutzformel jenseits von T_s, Kennzahlen, Zinsfuß und Bandbreite als Formeln, Punkt 11 der Checkliste; Wertfassung = Formelfassung in 16 Prüfgruppen; ohne Rechenwirkung, kein Schemaschritt; E14‑Q1…Q3 offen (→ Register R‑E14) | **#477** (Merge `NACHTRAG-477-MERGE2`) |
