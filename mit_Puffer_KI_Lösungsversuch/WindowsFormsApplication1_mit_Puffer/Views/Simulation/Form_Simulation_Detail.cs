...
namespace WindowsFormsApplication1
{
    public partial class Form_Simulation_Detail : Form
    {
        ...
        SystemsimulationNeu simNeu = new SystemsimulationNeu();
        SimulationControl simBestehend;   // haelt das Bestandsmodell, sobald einmal gemerkt
        ...
        public void UpdateTabPages()
        {
            ...
            dictParameterTabPages.Add("tabPage_ModellRB", this.tabPage_ModellRB);
            ...
            if (dictParameterTabPages.TryGetValue("tabPage_ModellRB", out gefundeneSeite) && gefundeneSeite != null)
                tabControl_Einstellungen.TabPages.Add(gefundeneSeite);
        ...
        private void btn_Simulation_Click(object sender, EventArgs e)
        {
            ...
            // Modell-Auswahl (Checkbox, nur zur Laufzeit): bestehendes oder neues gekoppeltes Modell
            if (simBestehend == null) simBestehend = sim;
            if (chk_ModellNeu.Checked)
            {
                simNeu.VorlaufAusleg   = (double)num_VorlaufAusleg.Value;
                simNeu.RuecklaufAusleg = (double)num_RuecklaufAusleg.Value;
                simNeu.Bivalenz        = (double)num_Bivalenz.Value;
                sim = simNeu;
            }
            else
            {
            ...
            sim.VolumenPendelspeicherBHKW = (double)numericUpDown_Volumen.Value;
