...
| [`ueberholt/Protokolle/Bericht/`](ueberholt/Protokolle/Bericht/) | 2 | `LIESMICH_Phase1.md` — Phasen-Historie des Berichtsmoduls; `DG_E1x_Zeichenmodell_Protokoll.md` — Etappe E1 des Diagrammkonzepts: das Zeichenmodell hinter dem `ChartRenderer` (E1a Modell, Maler, Farbrollen, Skala und die 15 Zeitreihenbilder; E1b und E1c folgen) |
