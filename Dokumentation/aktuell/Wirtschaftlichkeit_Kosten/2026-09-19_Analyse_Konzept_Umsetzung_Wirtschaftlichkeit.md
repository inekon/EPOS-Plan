...
`51c49577` · `SchemaStand.Zielversion` = **110**, Schemaschritte 90–110 vergeben (105 = K‑1, #440; 108–110 =
die Schritte E, F, G, #446), **nächster freier Schritt 111** · Gegenstand: das konsolidierte Konzept
...
> **Nachtrag 23.09.2026 (#432 bis #446).** Gebaut sind inzwischen auch **E4** (#432), **E5** (#434),
...
> umgesetzt, die acht Fragen E7c1‑Q1 bis E7c1‑Q8 am 23.09.2026 entschieden) und **E7 Teil c2** (#446: die
> Schritte E, F, G als Schemaschritte 108, 109, 110, die Sperre S‑2, V‑1/V‑2, B‑4 Rest und die Reste aus E7c1;
> die acht Fragen E7c2‑Q1 bis E7c2‑Q8 am 23.09.2026 entschieden); der Schnitt **A13** ist mit #435
> ausgeführt. **Nächste Etappe: E7c3**, danach E8. Die Schemaschritte sind am 23.09.2026 neu geordnet (§ 6):
> 101 Gebäudesimulation, 102 Nr. 30, 103 Zapfprofilgenerator, 104 Q11, 105 K‑1 (gebaut #440), 106
> Datenbereinigung der Welle #444, 107 Gebäudesimulation E30, 108–110 die Schritte E, F, G (gebaut #446).
...
5. **Das Datenmodell ist gesünder als das Konzept sagt:** alle 20 Wirtschaftlichkeitstabellen sind
   ...
   ist 105, gebaut #440; E, F und G sind 108, 109 und 110, gebaut #446; die übrigen ab **111**) und ein
   DML-Schritt für den Einheitenbruch, der entgegen dem Konzept nie gelaufen ist (Schritt 62 löscht
   Klimawaisen) — **gebaut #446** als Schritt 110 (G). Nur der Anschluss der
...
umgesetzt #439, E7 Teil c1 — umgesetzt #440, E7 Teil c2 — umgesetzt #446** (Einzelheiten in der Tafel oben, in
den Statuszeilen und ihren Protokollen); der **A13-Schnitt** ist mit #435 ausgeführt. **Nächste Etappe:**
**E7c3** (E7c2‑Q5 b und Q8 b, B‑6, Kapitalwert 1024, der Rest von Konzept § 6.3 Nr. 9h, die Katalogzeilen ohne
Leser, H_i = H_s = 1,0 für den Brennstoff 24; die acht Fragen aus E7c2 sind am 23.09.2026 entschieden), danach
**E8**. **E7c3 bis E12** bleiben offen, E11 entfällt.
...
Ergebnistabelle je Gebäude der Gebäudesimulation (`SCHRITT_107_ERGEBNIS_GEBAEUDE`, Entscheid E30) — und die
drei Schritte von E7 Teil c2 (#446): **108** = E, **109** = F, **110** = G (gebaut als 107/108/109 und beim
Zusammenführen mit 106 und 107 umnummeriert). `SchemaStand.Zielversion` steht auf **110**; der **nächste
freie Schritt ist 111**.
...
111), und der Umsetzende misst sie an `SchemaStand.Zielversion` neu — nicht an diesem Papier. Alle
...
| **108** (E) | 101 | `ErsatzFuehren`, `RestwertAnsetzen` (nullbar, CHECK; NULL = wie bisher) — **reines DDL** (`SCHRITT_108_ERSATZ_RESTWERT_KENNZEICHEN`), ergebnisneutral | `Tab_ProjektWerte`, `Tab_KostenVorlagePosition` | nein | nein | E7 Teil c2, **gebaut #446** |
| **109** (F) | 102 | `Preisbasis` (TEXT, nullbar) mit einmaligem DML aus `ID_Umrechnung` (`SCHRITT_109_PREISBASIS`; Testdatenbank 5 Zeilen „kWh", 23 Abrechnungseinheit) | `energy_project_settings` | nein | nein | E7 Teil c2, **gebaut #446** |
| **110** (G) | 103 | U‑1: `Einheit`/`PreisEinheit` der fünf Gase auf `Nm³`, eine `energy_price`-Zeile (Projekt 1039), dazu der Brennstoff 24 auf `kWh` (E7c2‑Q4) — **reines DML** (`SCHRITT_110_GASE_NM3`), vor dem Vorlagenbau | `Tab_Brennstoff_Stamm`, `energy_price` | nein | nein (Einfrierliste nennt nur CO₂/SO₂/NOx/Staub) | E7 Teil c2, **gebaut #446** |
