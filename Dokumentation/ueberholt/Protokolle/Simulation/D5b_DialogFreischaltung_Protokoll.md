...
| `MyResource/Resource.resx`, `Resource.en-US.resx`, `Resource.Designer.cs` | — | 11 neue Schlüssel, ein Text gekürzt (Nachtrag in [`Lokalisierung_Katalog.md`](../../../aktuell/Lokalisierung_Katalog.md)) |
