...
| **E21 Pflegewelle (Konzept § 6.3 Nr. 23, 24)** — **umgesetzt #506** | resx-Sammelnachtrag erledigt: zwei verwaiste Schlüssel aus de/en/Designer gestrichen, drei Rückfalltexte in `EnergietraegerHuelle.cs` an die resx angeglichen, Kommentare `KiDialoge.cs` und `SteuerGutschriftRechner.cs` nachgezogen (Nr. 23); Nr. 24 und die Datenlücken der Projekte 1018, 1024, 1023, 1030, 1026 gemessen und benannt, keine Datenpflege | S | nein | Anker unberührt, Referenzlauf 13/13 gegen R14 byte-gleich, Testdatenbank unverändert (`a427aa72`) | — (kein Schemaschritt) | kein Wiki | Opus | Anwender 25.09.2026 („sonst nach Empfehlung“) — **umgesetzt #506** (Merge `36a3fc89`; Zweig `e21`: E21/1 `25984cbd`, E21/2 `02ea7650`; E21‑Q1…Q9 entschieden 25.09.2026, nach Empfehlung, alle a) |
