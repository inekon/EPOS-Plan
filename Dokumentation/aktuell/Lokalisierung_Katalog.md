...
- **Nicht** in dieser Tabelle: DB-Persistenzwerte (die stehen in
  [`../DbWerte.cs`](../../EPOS.Kern/Allgemein/DbWerte.cs) und bleiben deutsch), Monats- und Wochentagsnamen
...
| `SIM_HEIZKREIS_BEIDES` | Heizkreis (Heizung + Warmwasser) | Heating circuit (heating + hot water) | WaermesenkeClass.cs:707 |
...
[`../Reporting/Kostenuebernahme_Protokoll.md`](../ueberholt/Protokolle/Reporting/Kostenuebernahme_Protokoll.md):
...
[`../Update/Anlagenzeilen_Eindeutigkeit_Protokoll.md`](../ueberholt/Protokolle/Update/Anlagenzeilen_Eindeutigkeit_Protokoll.md).
...
[`../Reporting/Konzept_BHKW_Kosten_Erloese.md`](../ueberholt/Protokolle/Reporting/Konzept_BHKW_Kosten_Erloese.md);
Befundlage, Seed-Liste und Verifikation in
[`../Reporting/W4_E1_Gesetzesparameter_Protokoll.md`](../ueberholt/Protokolle/Reporting/W4_E1_Gesetzesparameter_Protokoll.md).
...
[`../Reporting/W4_E2_Vollbenutzungsstunden_Protokoll.md`](../ueberholt/Protokolle/Reporting/W4_E2_Vollbenutzungsstunden_Protokoll.md).
...
Verifikation im
[`../Reporting/W4_E4_Steuergutschriften_Protokoll.md`](../ueberholt/Protokolle/Reporting/W4_E4_Steuergutschriften_Protokoll.md).
...
> [L-Protokoll](../ueberholt/Protokolle/Simulation/L_Aufraeumen_Protokoll.md), Abschnitt 5).
...
| `SIMENG_SENKENLISTE_LEER` | {0}: keine Senke zugeordnet – der Lauf nimmt {1}. | {0}: no heat sink assigned – the run uses {1}. | dieselbe Methode (A1, Rang-1-Invariante). **{1} ist jetzt eine Anzeige in Anwendersprache** (`SIM_HEIZKREIS_BEIDES`) statt eines Persistenzwerts; der zweite Platzhalter entfällt. |
...
Zahlen und Fundstellenliste im [L-Protokoll](../ueberholt/Protokolle/Simulation/L_Aufraeumen_Protokoll.md), Abschnitt 5.4). Paket L
