...
namespace WindowsFormsApplication1
{
    ...
    public static class SchemaMigration
    {
        ...
        /// <summary>
        /// Schritt 125 — <b>der Heizkreis je Gebäude im Ergebnis</b> (Konzept Anlagenkopplung
        /// 8.3 und 9.4, Muster E30; Stufe AK1 Welle 3). Er folgt auf
        /// <see cref="SCHRITT_124_ZAPFPROFIL_LAUFANGABEN"/> ohne Reihenfolgebedingung; er braucht
        ...
        /// </summary>
        public const int SCHRITT_125_ERGEBNIS_HEIZKREIS = 125;
        ...
        private static readonly Schritt[] SCHRITTE_SQLITE =
        {
            ...
            // ErgebnisGebaeudeSchema.SpaltenHeizkreis. Er steht NACH 124 ohne
            // Reihenfolgebedingung und braucht 107.
            new Schritt(SCHRITT_125_ERGEBNIS_HEIZKREIS,
        ...
        // =================================================================================
        // Schritt 125 - der Heizkreis je Gebaeude im Ergebnis (Anlagenkopplung AK1 Welle 3)
        // =================================================================================

        /// <summary>
        /// Schritt 125 — Anlass und Wirkung stehen bei <see cref="SCHRITT_125_ERGEBNIS_HEIZKREIS"/>,
        ...
        /// </summary>
        private static bool Schritt_125_ErgebnisHeizkreis(Lauf l)
        {
            if (!SqliteTabelleVorhanden(ErgebnisGebaeudeSchema.TAB))
            {
            ...
            l.Notiz("125: " + angelegt.ToString(CultureInfo.InvariantCulture) + " von " +
