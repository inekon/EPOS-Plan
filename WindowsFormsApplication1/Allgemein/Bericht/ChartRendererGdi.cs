...
{
    // =========================================================================
    // Alt-Renderer, nur fuer den Bildvergleich iU7, wird nach der Abnahme geloescht.
    //
    // WORTGLEICHE KOPIE des GDI+-Standes von ChartRenderer.cs (Basis 9fe9c71) —
    // veraendert wurden ausschliesslich der Klassenname, das Plattformattribut und
    // dieser Kopf. Sie ist die VERGLEICHSSEITE des Modus "bildvergleich" im
    // Referenzlauf: derselbe Datensatz laeuft einmal hier und einmal durch den
    // portierten SkiaSharp-Renderer, die beiden PNG werden Pixel fuer Pixel
    // gegeneinander gehalten. Nach der Abnahme unter Windows ist diese Datei
    // ersatzlos zu loeschen — sie ist bewusst KEINE zweite gepflegte Quelle.
    //
    // Die geschachtelten Typen Segment/Balken/Reihe sind EIGENE Kopien mit
    // System.Drawing.Color; sie duerfen nicht mit denen des neuen Renderers
    // verwechselt werden (dort SKColor).
    // =========================================================================
    ...
    public static class ChartRendererGdi
    {
