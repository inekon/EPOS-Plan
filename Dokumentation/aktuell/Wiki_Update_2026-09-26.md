...
| Programm Dokumentation/Simulation | `Projekte/Wiki/Programm Dokumentation - Simulation.wiki` | neuer Punkt „Kühlbetrieb der Wärmepumpe" in der Simulationskonfiguration (Anker `kuehlbetrieb`); neuer Punkt „Anlagenkopplung" (Anker `anlagenkopplung`); mit E12 eine Tabuwort-Bereinigung (keine inhaltliche Änderung) | Status der Gebäudesimulation, Stufe KU2; E12 |
