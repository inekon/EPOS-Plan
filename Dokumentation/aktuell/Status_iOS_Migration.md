...
- **Nach #250:** Versionsnummer für die 20 Logbuch-Einträge (Vorschlag 1.2.0.0) und deren Upload ins „Update-Logbuch"; die `<pre>`-Kästen aus eingerückten Fortsetzungszeilen auf elf Rechenwegseiten als eigener Auftrag.
