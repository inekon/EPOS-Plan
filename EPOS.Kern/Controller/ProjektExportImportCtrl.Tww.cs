...
namespace WindowsFormsApplication1
{
    ...
    /// verglichen.</para>
    ///
    /// <para><b>Schemaschritt 120 (T3).</b> Die Laufangaben der Auslegung an <c>Tab_TwwProjekt</c>
    ...
    /// Führt die Zieldatenbank die Spalten noch nicht (Stand vor 120), läuft der Import durch wie
    /// bei einer Kindtabelle vor 115; der Bericht nennt je Spalte, wie viele Werte liegen bleiben
    /// (<see cref="TwwSchritt120Melden"/>) — benannt, nie still.</para>
    /// </summary>
    public partial class ProjektExportImportCtrl
    {
        ...
        /// <summary>
        /// Meldet für jede Spalte des Schemaschritts 120 (<see cref="TwwSchema.SpaltenT3"/>), die das
        /// Paket mit einem Wert trägt, die Zieldatenbank aber nicht führt (Stand vor 120), eine
        ...
        /// </summary>
        private void TwwSchritt120Melden(IEnumerable<Dictionary<string, List<Dictionary<string, JsonElement>>>> baeume,
                                         Dictionary<string, List<Dictionary<string, JsonElement>>> katalogzeilen)
        {
            ...
            foreach (TwwSpalte s in TwwSchema.SpaltenT3)
            {
                ...
                _twwBericht.Add("Die Zieldatenbank fuehrt " + s.Tabelle + "." + s.Name + " noch nicht (Schemastand vor 120): " +
