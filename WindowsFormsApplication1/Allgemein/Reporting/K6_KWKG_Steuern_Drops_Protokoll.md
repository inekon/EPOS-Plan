...
| | |
|---|---|
| Schritt | **30** — `SCHRITT_30_ENERGIETRAEGER_ABFRAGE` (Nummer frei; Branch stand auf der `origin/main`-Spitze `4cbf9ec`, nach Fetch gegengeprüft) |
...
(`energy_project_settings`, `energy_carrier` — bei Schritt 30 ohnehin garantiert, ohne sie
