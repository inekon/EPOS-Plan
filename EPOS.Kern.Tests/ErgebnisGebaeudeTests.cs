...
{
    /// <summary>
    /// <b>Die Ergebnistabelle je Gebäude</b> (Entscheid E30, Schemaschritt 104, Konzept
    ...
    public sealed class ErgebnisGebaeudeTests : IDisposable
    {
        ...
        /// <summary>
        /// Der Schritt vom Vorzustand 103: Auf der Testdatenbank ohne die Tabelle legen die
        ...
        public void Der_Schritt_fuehrt_die_Testdatenbank_vom_Vorzustand_auf_den_Zielstand()
        {
            ...
            Assert.True(Convert.ToInt32(DataRepository.ExecuteScalar("SELECT SchemaVersion FROM Tab_Applikation")) >= 104);
